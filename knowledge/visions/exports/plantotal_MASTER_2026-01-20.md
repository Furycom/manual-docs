# PLAN TOTAL — BRUCE — MASTER (Unified)
Date (UTC): 2026-01-20

## Règle d’or
- Ce fichier est une **fusion sans perte** : V3 (canon structurel) + annexes V2/V1 (legacy).
- En cas de contradiction: Checklist > Handoff > État réel observé > Handbook/archives > visions legacy.

## Notes importantes
- V1/V2 contiennent du contenu de type **BRUCE_MASTER_PLAN** (potentiellement contradictoire).
- Ce contenu est conservé **tel quel** en annexes, pour traçabilité et récupération d’idées/détails.
