# MCP Homelab Manual – snapshot

_Snapshot generated at (UTC): 20251119-141519_
...
## Source file: `architecture/furyai-box.md`
...
## Source file: `architecture/physical-overview.md`
...
## Source file: `architecture/proxmox-box.md`
...
## Source file: `architecture/roadmap-and-vision.md`
...
## Source file: `architecture/truenas-box.md`
...
## Source file: `operations/backups-and-snapshots.md`
...
## Source file: `operations/homelab-journal.md`
...
## Source file: `operations/homelab-prompt.md`
...
_Last generated at_: **2025-11-19T14:15:19.845327+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T14:15:19.845327+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up About a minute | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 25 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 25 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 25 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 42 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 42 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 42 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-11-19T14:15:05**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 14 hours, 44 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.06 0.10 0.08 3/564 491350`
> 
> ## Uptime (raw)
> 
> ```text
> 14:15:05 up 3 days, 14:44,  2 users,  load average: 0.06, 0.10, 0.08
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       987Mi       1.1Gi       1.1Mi       2.0Gi       2.8Gi
...
> - CPU load (1 min): **0.06** on **2** cores (per-core: **0.03**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-19T14:15:09**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 51 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.22 0.16 0.07 1/376 1565245`
> 
> ### Uptime (raw)
> 
> ```text
> 14:15:07 up 8 days, 51 min,  1 user,  load average: 0.15, 0.15, 0.06
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       4.6Gi       198Mi        32Mi       3.2Gi       3.1Gi
...
> 
> _Generated at_: **2025-11-19T14:15:10**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-19T14:15:19**
> 
> 
...
> 	+ `mcp-gateway` (MCP Gateway) up and running.
> 	+ `code-server` (Code Server) up and running.
> 	+ `netdata` (Netdata) up and healthy.
> 	+ `dashy` (Dashy) up and healthy.
> * **Important stacks:**
> 	+ MCP VM up for 3 days, 14 hours, 44 minutes.
> 	+ furyai AI/GPU box up for 8 days, 51 minutes.
> * **Memory usage:** 25.4% used on MCP VM, 63.0% used on `/` (OK).
> * **CPU load:** 0.06 on 2 cores (per-core: 0.03) → OK.
> * **Disk usage:** 63.0% used on `/` (OK).
> * **furyai status:** up for 8 days, 51 minutes; memory usage 4.6Gi used out of 7.7Gi total.
> * **AI/GPU box containers:**
> 	+ `cloudflared` up and running.
> 	+ `ollama` up and healthy.
> 	+ `openwebui` up and healthy.
> * **Portainer container:** up and running on MCP VM.
> * **Anomalies/errors:** None detected.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
## Source file: `operations/manual-exports.md`

# Manual exports & downloads

Cette page décrit comment récupérer un **snapshot complet** du manuel MCP
en un seul fichier Markdown.
...
## Source file: `operations/using-manual-from-llm.md`
...
## Source file: `services/core-services.md`
...
## Source file: `services/daily-summary-mcp.md`
...
## Source file: `services/furyai-status.md`
...
## Source file: `services/llm-access.md`
...
## Source file: `services/mcp-health-report.md`
...
## Source file: `services/monitoring.md`
...
## Source file: `services/planned-services.md`
...
## Source file: `services/proxmox-status.md`
...
## Source file: `services/runtime-status-mcp.md`
...
## Source file: `services/system-status-mcp.md`
...
## Source file: `services/truenas-status.md`
...
RZ1-5TB-4X/ix-applications/k3s                                                7.07G   960G  7.06G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.91M   960G  2.91M  legacy
...
RZ2-11TB-6X/.system                                                           2.59G  2.18T  2.04G  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   366M  2.18T   366M  legacy
...
## Source file: `stacks/admin-portal.md`
...
## Source file: `stacks/mcp-stack.md`
...
## Source file: `vms/homeassistant-vm.md`
...
## Source file: `vms/mcp-gateway-vm.md`
...
## Source file: `vms/proxmox-vms.md`
...
## Source file: `vms/supabase-vm.md`
