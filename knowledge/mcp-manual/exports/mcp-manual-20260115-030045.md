...
_Last generated at_: **2026-01-15T03:00:44.520477+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-15T03:00:44.520477+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 37 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 3 days | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 3 days | `-` |
...
> 
> _Generated at_: **2026-01-15T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 13 hours, 38 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.23 0.35 0.36 3/778 832734`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 3 days, 13:38,  2 users,  load average: 0.23, 0.35, 0.36
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.3Gi       1.2Gi       790Mi       264Ki       1.6Gi       2.1Gi
> Swap:          3.8Gi       484Mi       3.3Gi
> ```
> 
...
> 
> _Generated at_: **2026-01-15T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 4 days, 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.13 0.13 0.15 2/372 1039165`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 4 days, 12:28,  3 users,  load average: 0.13, 0.13, 0.15
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       1.8Gi       643Mi       3.6Mi       5.5Gi       5.9Gi
> Swap:           23Gi       747Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2026-01-15T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-15T03:00:43**
> 
> 
...
> * **Services:**
> 	+ `mcp-manual` (MKDocs) up and running
> 	+ `mcp-gateway` up and running
> 	+ `code-server` up and running (required for development)
> 	+ `dashy` up and running (required for monitoring)
> 	+ `netdata` up and running (required for monitoring)
> * **Anomalies:**
> 	+ High disk usage on `/` (59% used) - warning
> * **Running containers:**
> 	+ `mcp-shell`, `portainer`, and `termix` are running, but not required
> * **Uptime:** MCP VM up 3 days, 13 hours, 38 minutes; furyai box up 4 days, 12 hours, 28 minutes
> * **Memory usage:**
> 	+ MCP VM memory usage is within healthy limits (36.7% used)
> 	+ furyai box memory usage is high (1.8Gi used) - warning
> * **System information:** CPU load average on both hosts is low (<0.5)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 2 days (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 4 days|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 4 days|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdl2                                ONLINE       0     0     0
	    sdj2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     0     0   115  too many errors
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.23M   412G  2.23M  legacy
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.8M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.3M   412G  37.5M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        413G  2.3M  413G   1% /var/lib/kubelet
