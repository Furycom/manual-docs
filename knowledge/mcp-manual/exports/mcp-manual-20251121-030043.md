...
_Last generated at_: **2025-11-21T03:00:43.429518+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-21T03:00:43.429518+00:00.
...
> | `dashy` | `lissy93/dashy` | Up 24 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-11-21T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 5 days, 3 hours, 29 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.07 0.02 0.00 1/566 572952`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 5 days,  3:29,  2 users,  load average: 0.07, 0.02, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.0Gi       1.3Gi       1.2Mi       1.8Gi       2.8Gi
> Swap:          3.8Gi       2.3Mi       3.8Gi
> ```
> 
...
> 
> _Generated at_: **2025-11-21T03:00:02**
> 
> 
> ## Summary
> 
...
> - Memory usage: **25.9%** → `OK`
> - CPU load (1 min): **0.07** on **2** cores (per-core: **0.04**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-21T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 2 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/363 1817754`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 9 days, 13:36,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.9Gi       1.1Gi       440Ki       4.0Gi       4.8Gi
...
> 
> _Generated at_: **2025-11-21T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-21T03:00:43**
> 
> 
...
> 	+ MCP Gateway VM up 5 days
> 	+ Code-server container up 2 days
> 	+ Netdata container up 3 days (healthy)
> 	+ Dashy container up 24 hours (healthy)
> 	+ Cloudflared, Ollama, Openwebui containers on furyai up 9 days (healthy)
> * Running services and stacks:
> 	+ MCP-manual container up 24 hours
> 	+ Portainer container up 3 days
> 	+ mcp-shell container up 2 days
> * Anomalies and errors:
> 	+ Root filesystem usage on MCP VM at 63% (OK, but may require attention soon)
> 	+ Swap space on furyai at 89% (may require attention soon)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 9 days|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 9 days (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 9 days (healthy)|| |
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.05M   960G  3.05M  legacy
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   112M  2.19T   112M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   377M  2.19T   377M  legacy
...
RZ2-11TB-6X/HomeAsistant_dataset                                              86.7G  2.19T   208K  /mnt/RZ2-11TB-6X/HomeAsistant_dataset
RZ2-11TB-6X/HomeAsistant_dataset/haos_zvol                                    86.7G  2.25T  21.9G  -
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        960G  3.2M  960G   1% /var/lib/kubelet
