...
_Snapshot generated at (UTC): 20251119-141320_
...
_Last generated at_: **2025-11-19T14:13:20.479147+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T14:13:20.479147+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 5 minutes | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
...
> 
> _Generated at_: **2025-11-19T14:12:37**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 14 hours, 41 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.02 0.10 0.07 1/563 491026`
> 
> ## Uptime (raw)
> 
> ```text
> 14:12:37 up 3 days, 14:41,  2 users,  load average: 0.02, 0.10, 0.07
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       970Mi       1.1Gi       1.1Mi       2.0Gi       2.9Gi
...
> 
> _Generated at_: **2025-11-19T14:12:41**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.04 0.01 1/362 1564557`
> 
> ### Uptime (raw)
> 
> ```text
> 14:12:39 up 8 days, 48 min,  1 user,  load average: 0.08, 0.04, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       3.7Gi       1.1Gi       448Ki       3.2Gi       4.0Gi
...
> 
> _Generated at_: **2025-11-19T14:12:42**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-19T14:13:20**
> 
> 
...
> * **Overall Health**: OK
> * **Running Services**:
> 	+ `mcp-gateway`: Up 25 hours
> 	+ `code-server`: Up 25 hours
> 	+ `netdata`: Up 42 hours (healthy)
> 	+ `dashy`: Up 42 hours (healthy)
> 	+ `portainer`: Up 42 hours
> * **Anomalies**:
> 	+ `/` filesystem usage: 63.0% (OK but above threshold)
> 	+ `furyai` root filesystem usage: 89%
> * **Container Status**: All containers are up and healthy, except for none.
> * **Memory Usage**: 25.2% used on MCP VM, 45G used on `furycomai`
> * **CPU Load**: 0.02 (MCP VM), 0.08 (furyai)
> * **Uptime**:
> 	+ MCP VM: up 3 days, 14 hours
> 	+ furycomai: up 1 week, 1 day
> * **Disk Usage**:
> 	+ `/` filesystem on MCP VM: 19G used, 6.5G available
> 	+ `furycomai` root filesystem: 54G used, 5.8G available
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
RZ2-11TB-6X/.system/samba4                                                    7.14M  2.18T  1.31M  legacy
