...
_Last generated at_: **2026-01-19T03:00:40.795371+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-19T03:00:40.795371+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 9 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 7 days | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 7 days | `-` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 8 hours | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 7 days (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 7 days | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 7 days | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 7 days | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 7 days (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 7 days (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-19T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 1 week, 13 hours, 38 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.18 0.19 0.18 1/765 1808767`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 7 days, 13:38,  2 users,  load average: 0.18, 0.19, 0.18
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.3Gi       1.2Gi       747Mi       300Ki       1.7Gi       2.2Gi
> Swap:          3.8Gi       456Mi       3.4Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   37G   21G   15G  59% /
> ```
> 
> ## How to refresh this page
> 
...
> 
> _Generated at_: **2026-01-19T03:00:02**
> 
> 
> ## Summary
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **59.0%** → `OK`
> - Memory usage: **35.2%** → `OK`
> - CPU load (1 min): **0.18** on **2** cores (per-core: **0.09**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-19T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.06 0.01 1/368 1982522`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:03 up 8 days, 12:28,  2 users,  load average: 0.08, 0.06, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.1Gi       930Mi       3.8Mi       5.0Gi       5.6Gi
> Swap:           23Gi       689Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> ## Overall status
> 
> ⚠️ One or more pools are DEGRADED. Check disks and recent TrueNAS alerts.
> 
...
>   scan: resilvered 38.6G in 01:37:50 with 0 errors on Sat Jan 10 11:11:46 2026
> config:
> 
> 	NAME                                    STATE     READ WRITE CKSUM
> 	RZ1-5TB-4X                              DEGRADED     0     0     0
...
> 
> _Generated at_: **2026-01-19T03:00:40**
> 
> 
...
> ## Summary
> 
> Here is the daily summary of Yann's homelab MCP environment:
> 
> * Overall health: OK
> * Running services and stacks:
> 	+ `mcp-manual` (mkdocs-material) up for 24 hours on port 8181
> 	+ `mcp-gateway` (mcp-stack-mcp-gateway) up for 9 hours on port 4000
> 	+ Other containers (dozzle-agent, ntopng, termix, uptime-kuma, code-server, mcp-shell, portainer, netdata, dashy) all up and running
> * Important stacks:
> 	+ MCP Gateway VM is up and running with various services and stacks online
> 	+ furyai AI / GPU box is connected via SSH and shows a clean system status report
> * Anomalies, errors or things that may require attention soon:
> 	+ None reported in the provided status pages
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 6 days (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 8 days|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 8 days|| |
| `ollama` | `d353379de60a` | Up 5 days (healthy)|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdl2                                ONLINE       0     0     0
	    sdj2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     0     0 1.28K  too many errors

errors: No known data errors

  pool: RZ2-11TB-6X
 state: ONLINE
  scan: scrub repaired 0B in 06:08:57 with 0 errors on Sun Jan  4 06:08:58 2026
config:
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:44 with 0 errors on Mon Jan 12 03:54:46 2026
config:
...
RZ1-5TB-4X                                                                    4.76T   407G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.53T   407G  4.53T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.07G   407G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   407G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   407G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.70M   407G  2.70M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.7M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               59.6M   407G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   407G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.9M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.8M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.4M   407G  37.6M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   407G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   615G  12.6G  -
RZ2-11TB-6X                                                                   8.50T  2.27T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.59G  2.27T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   119M  2.27T   119M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   361M  2.27T   361M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.27T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.22M  2.27T  1.39M  legacy
...
boot-pool                                                                     8.50G  27.4G    24K  none
boot-pool/ROOT                                                                8.46G  27.4G    24K  none
boot-pool/ROOT/13.0-U4                                                        2.58G  27.4G  1.29G  /
boot-pool/ROOT/23.10.2                                                        5.87G  27.4G  5.87G  legacy
...
tmpfs                                                                         3.2G   20M  3.2G   1% /run
boot-pool/ROOT/23.10.2                                                         34G  5.9G   28G  18% /
tmpfs                                                                          16G  108K   16G   1% /dev/shm
...
RZ1-5TB-4X                                                                    408G  256K  408G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.6T  408G  92% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          409G  908M  408G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/k3s                                                416G  8.0G  408G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           408G  110M  408G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        408G  512K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  408G  256K  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     408G   38M  408G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  120M  2.3T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  362M  2.3T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        408G  2.8M  408G   1% /var/lib/kubelet
tmpfs                                                                         500M   12K  500M   1% /var/lib/kubelet/pods/e3a94e04-402f-4126-a894-29388bc2920b/volumes/kubernetes.io~projected/kube-api-access-zbk9f
...
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/b07a5e322946aad6dd5567c2f3c757c6e256b45ae5d2cc03cf988df5464106d2/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/59aee8af3b0b522f7801a406d73b9a854bf696581f658a472daccf2a95b25bb3/shm
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b07a5e322946aad6dd5567c2f3c757c6e256b45ae5d2cc03cf988df5464106d2/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/59aee8af3b0b522f7801a406d73b9a854bf696581f658a472daccf2a95b25bb3/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01f0b33e711abc2c0f37437c676f407a2d69512d53c7cc22ad1cc8327e26f67e/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/223a048ea6b44b9d1b658003b3440b034c7c5c8af28f30c39efe7603d567a93d/rootfs
tmpfs                                                                         170M   12K  170M   1% /var/lib/kubelet/pods/31d2c083-e58b-4b8b-b59c-3a321a2d323f/volumes/kubernetes.io~projected/kube-api-access-p6p5j
tmpfs                                                                         600M   12K  600M   1% /var/lib/kubelet/pods/6854eea4-5050-4249-a523-f20634c5c82f/volumes/kubernetes.io~projected/kube-api-access-jfswx
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/39f9eef5-7eb9-4132-8f5e-38682107df76/volumes/kubernetes.io~projected/kube-api-access-zfhns
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/17a41abe-c0d4-4a47-8af6-5d5fa6baa890/volumes/kubernetes.io~projected/kube-api-access-f6bjj
tmpfs                                                                         300M   12K  300M   1% /var/lib/kubelet/pods/4b81d552-3b4b-436b-895b-e3d501ae21b8/volumes/kubernetes.io~projected/kube-api-access-nhn8j
tmpfs                                                                         300M   12K  300M   1% /var/lib/kubelet/pods/0d494f97-cbc2-488a-b11a-b0b34bf7b116/volumes/kubernetes.io~projected/kube-api-access-2kmvq
tmpfs                                                                         900M   12K  900M   1% /var/lib/kubelet/pods/ed3c34f1-f2ca-494d-b8c8-6a688e55bd8f/volumes/kubernetes.io~projected/kube-api-access-tqrzs
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/9f2256cd-59ce-4132-8239-091a3392091c/volumes/kubernetes.io~projected/kube-api-access-jrj2m
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/39ea55bc46e6d96ad829d2cb18d23e0057171f3270557547abb3faf6c2f31d7f/shm
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/39ea55bc46e6d96ad829d2cb18d23e0057171f3270557547abb3faf6c2f31d7f/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/2fcb4ccd9ae36cc9393b21989e67dba99d4985032fb39fc3d9c2a37b525f9464/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/86ea434fd9b1d194861dab930c69c828968359ecf6be85ed008ad76b9336b5c0/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/9ee53875b27877a1f25b0bc39c1143c811c2dedce0122981d6554da0cee86761/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/7b5faf747768ce2efa416bd03e31a09d9aa3b1b42b8dff88181612ea96852908/shm
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/7b5faf747768ce2efa416bd03e31a09d9aa3b1b42b8dff88181612ea96852908/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/0f311a74d9e6eaa6b8f324aa881f6f2ee0c077e9b985b877417271821b7df4a5/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/bd43727c7471e4053e7ac54fb525975a2a098436007150e1a5516af4ce6c323b/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/5207bc904b33afbeaf9e87755c4adc5945ed10dd1f5b00c6445c487b5e2e40e5/shm
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/5207bc904b33afbeaf9e87755c4adc5945ed10dd1f5b00c6445c487b5e2e40e5/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/2fcb4ccd9ae36cc9393b21989e67dba99d4985032fb39fc3d9c2a37b525f9464/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/86ea434fd9b1d194861dab930c69c828968359ecf6be85ed008ad76b9336b5c0/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9ee53875b27877a1f25b0bc39c1143c811c2dedce0122981d6554da0cee86761/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/0f311a74d9e6eaa6b8f324aa881f6f2ee0c077e9b985b877417271821b7df4a5/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/bd43727c7471e4053e7ac54fb525975a2a098436007150e1a5516af4ce6c323b/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/097ddb6708982eca19972697ec4039c24c2bf907c4b3a41561b473dffcd922ac/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9657f14334aa0021e0fb51cc1ef642877ead61ba2ac773503f6c79cf441508d1/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/dd71d9aeb68027a88f5cfcf6705efa3ac61c7c7aeee42049f3e78291c50ed764/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/d72311caadb3c002219ce17b56bd10cdd81dcec5499ee7ad30724fcd41f2e177/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/51da8fe130086530ad513243cb2ca7ccb6658d9d9a8974297985940c4f02c2c8/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/2f4b046058fed2ef9a65e3b5b637bb4dcb6271e8c844856efa8fbc99f7bf59c0/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/93264e1b9b0ce7d24fa465251d6343951d905130d9d6937ec5e4950d94c514b6/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ac10bf5767955f4b02001211bcb6f7bf485f92c7009603c8c20c457cd6766a75/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9a5444c0e9d54861855c37674979ee10d913926796b7cf15e253634d05ffbef1/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ed47d511d770441f29ae8c1bd0670dcbe8a58eea6e5da0b6a2a9e1ffac5f147f/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/2ab6eefb90b4fd65e2770a401d2d22776dbde5a6a35fd050fb5852d8e6ce5bd0/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e9e5986e48b0847c691a2fea2c8f6207eaa2fe7baa96b8faafb0c0627b0c5f1d/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/b4cc3a44e437f1afc20d1362109070352162e3c87baaab85bece604c83c8a2df/shm
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b4cc3a44e437f1afc20d1362109070352162e3c87baaab85bece604c83c8a2df/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/72822ce2d63e5238f1dc90a08e8394147a07f477bd3d6985ab755f585bffc122/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e66099879fecebf19e828dbcfad02841f416d323778c8300365464fd6d1d7517/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/37c6f0ae1865e09c4463b819ef2e2d5baa0e3ef21c1ca68775c8b25f063e5544/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/feab3709a0d6f6b22781d27749e6e3bebcbf4d566a0cb00f5f3372662481bccb/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9262bfdd5878a05bab8edac6f6884c9cda04f2af57564d6ec6b696e2cb407c8e/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9913c3adb81ca92e16c013911fb08aab1e6a5336e37bb2b8dddfbb16ceb4c964/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/2d344b3923c1bae06f77342957762697d5d26fd3d063b41d36da787dbf8b0902/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/662c7c1873c943c20b47947daa14e1caa90bc2c13bcebf79c9713a43070c6c2f/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/7a4e0d5e5277fb7b1e78434e517bf79ef2e17620ae6f11c6ba490c70e8816c18/rootfs
overlay                                                                       416G  8.0G  408G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ae5089a6dfd3e9361b84a51758e88b535621b68cfb339a07383130965b0ec8cb/rootfs
```
