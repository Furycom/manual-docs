...
_Last generated at_: **2025-12-15T03:00:48.125264+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-15T03:00:48.125264+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 8 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 8 hours | `-` |
...
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 8 hours (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 8 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 8 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 8 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 8 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 8 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-12-15T03:00:05**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 8 hours, 29 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.20 0.14 0.15 1/710 61113`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:06 up  8:29,  1 user,  load average: 0.20, 0.14, 0.15
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.1Gi       1.6Gi       548Ki       1.3Gi       2.7Gi
> Swap:          3.8Gi       231Mi       3.6Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   37G   19G   17G  54% /
> ```
> 
> ## How to refresh this page
> 
...
> 
> _Generated at_: **2025-12-15T03:00:06**
> 
> 
> ## Summary
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **54.0%** → `OK`
> - Memory usage: **30.4%** → `OK`
> - CPU load (1 min): **0.20** on **2** cores (per-core: **0.10**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-15T03:00:10**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 days, 13 hours, 13 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.02 0.01 1/337 490873`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:08 up 2 days, 13:13,  2 users,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.4Gi       503Mi       5.0Mi       5.1Gi       5.3Gi
> Swap:           23Gi       768Ki        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   46G  5.2G  90% /
> ```
> 
...
> 
> _Generated at_: **2025-12-15T03:00:11**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-15T03:00:46**
> 
> 
...
> ## Summary
> 
> Here is the daily MCP summary in English, using bullet points, and highlighting overall health, important running services and stacks, and any anomalies or things that may require attention soon:
> 
> * **Overall Health**: OK
> * **Running Services**:
> 	+ `mcp-manual`: Running on MCP Gateway VM (8 hours)
> 	+ `ntopng`, `uptime-kuma`, `netdata`, `dashy`: All healthy and running on MCP Gateway VM
> 	+ `code-server`, `termix`, `portainer`, `mcp-shell`: Running on MCP Gateway VM, no issues reported
> * **Stacks**:
> 	+ MCP Stack: Running on MCP Gateway VM (8 hours)
> 	+ furyai system: Up 2 days, 13 hours, 13 minutes, CPU load OK
> * **Anomalies/Errors**:
> 	+ No major issues detected based on current thresholds in the MCP health report
> 	+ `/` filesystem usage is at 54.0% (OK), memory usage is at 30.4% (OK)
> 	+ Root filesystem usage on furyai is at 90% ( warning: may require attention soon)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 2 days|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 2 days (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 2 days (healthy)|| |
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:39 with 0 errors on Mon Dec  8 03:54:42 2025
config:
...
RZ1-5TB-4X                                                                    4.66T   504G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.44T   504G  4.44T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.07G   504G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   504G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   504G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.74M   504G  3.74M  legacy
RZ1-5TB-4X/ix-applications/releases                                           60.6M   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               60.5M   504G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   504G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       59.9M   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            59.7M   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     59.4M   504G  38.5M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   504G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   712G  11.0G  -
RZ2-11TB-6X                                                                   8.58T  2.19T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.60G  2.19T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   115M  2.19T   115M  legacy
RZ2-11TB-6X/.system/cores                                                      192K  1024M   192K  legacy
RZ2-11TB-6X/.system/ctdb_shared_vol                                            192K  2.19T   192K  legacy
RZ2-11TB-6X/.system/glusterd                                                   192K  2.19T   192K  legacy
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   376M  2.19T   376M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.19T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.14M  2.19T  1.31M  legacy
RZ2-11TB-6X/.system/services                                                   192K  2.19T   192K  legacy
RZ2-11TB-6X/.system/syslog-cadb1ce96f8c4a01a65be3ef8f5cb996                   5.53M  2.19T  5.53M  legacy
RZ2-11TB-6X/.system/webui                                                      192K  2.19T   192K  legacy
RZ2-11TB-6X/HomeAsistant_dataset                                              86.4G  2.19T   208K  /mnt/RZ2-11TB-6X/HomeAsistant_dataset
RZ2-11TB-6X/HomeAsistant_dataset/haos_zvol                                    86.4G  2.25T  21.9G  -
RZ2-11TB-6X/MopidyDataset                                                      192K  2.19T   192K  /mnt/RZ2-11TB-6X/MopidyDataset
RZ2-11TB-6X/RZ2-11TB-6X                                                       8.49T  2.19T  8.49T  /mnt/RZ2-11TB-6X/RZ2-11TB-6X
RZ2-11TB-6X/ix-applications                                                   1.31G  2.19T   288K  /mnt/RZ2-11TB-6X/ix-applications
RZ2-11TB-6X/ix-applications/catalogs                                          73.1M  2.19T  73.1M  /mnt/RZ2-11TB-6X/ix-applications/catalogs
RZ2-11TB-6X/ix-applications/default_volumes                                    192K  2.19T   192K  /mnt/RZ2-11TB-6X/ix-applications/default_volumes
RZ2-11TB-6X/ix-applications/k3s                                               1.24G  2.19T  1.24G  /mnt/RZ2-11TB-6X/ix-applications/k3s
RZ2-11TB-6X/ix-applications/k3s/kubelet                                        623K  2.19T   623K  legacy
RZ2-11TB-6X/ix-applications/releases                                           192K  2.19T   192K  /mnt/RZ2-11TB-6X/ix-applications/releases
boot-pool                                                                     8.54G  27.3G    24K  none
boot-pool/ROOT                                                                8.50G  27.3G    24K  none
boot-pool/ROOT/13.0-U4                                                        2.58G  27.3G  1.29G  /
boot-pool/ROOT/23.10.2                                                        5.92G  27.3G  5.92G  legacy
boot-pool/ROOT/Initial-Install                                                   1K  27.3G  1.29G  legacy
boot-pool/ROOT/default                                                         188K  27.3G  1.29G  legacy
boot-pool/grub                                                                1.64M  27.3G  1.64M  legacy
```
...
boot-pool/ROOT/23.10.2                                                         34G  6.0G   28G  18% /
...
RZ1-5TB-4X                                                                    504G  256K  504G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.5T  504G  91% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications/k3s                                                512G  8.0G  504G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           504G  110M  504G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases                                           504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        504G  512K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  504G  256K  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     504G   39M  504G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ2-11TB-6X/.system                                                           2.2T  2.1G  2.2T   1% /var/db/system
RZ2-11TB-6X/.system/cores                                                     1.0G  256K  1.0G   1% /var/db/system/cores
RZ2-11TB-6X/.system/samba4                                                    2.2T  1.4M  2.2T   1% /var/db/system/samba4
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  116M  2.2T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  376M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        504G  3.8M  504G   1% /var/lib/kubelet
tmpfs                                                                         3.2G     0  3.2G   0% /run/user/0
RZ1-5TB-4X/minecraft                                                          505G  908M  504G   1% /mnt/RZ1-5TB-4X/minecraft
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/b6cf8af89850fdb2946ab3402b8641750a67feec6de0838c4fb10b0cf05e4057/shm
tmpfs                                                                         500M   12K  500M   1% /var/lib/kubelet/pods/7ed6824a-1e32-4eae-87e9-70fc933baa7b/volumes/kubernetes.io~projected/kube-api-access-9fkn6
tmpfs                                                                         400M   12K  400M   1% /var/lib/kubelet/pods/c25ce9d3-7960-4def-8f68-69aa14b8e6d4/volumes/kubernetes.io~projected/kube-api-access-bbrkq
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b6cf8af89850fdb2946ab3402b8641750a67feec6de0838c4fb10b0cf05e4057/rootfs
tmpfs                                                                         300M   12K  300M   1% /var/lib/kubelet/pods/a77fca45-dc9f-4fdb-aed9-bd01dccece23/volumes/kubernetes.io~projected/kube-api-access-2dctq
tmpfs                                                                         300M   12K  300M   1% /var/lib/kubelet/pods/7cc8d76b-ea28-4c53-be7c-4b0f7728d032/volumes/kubernetes.io~projected/kube-api-access-v8fs8
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/0b135c2e-cd56-45bd-b49c-abf021a06747/volumes/kubernetes.io~projected/kube-api-access-8hvqj
tmpfs                                                                         600M   12K  600M   1% /var/lib/kubelet/pods/5b06df54-3c77-459a-b266-ad68d186218d/volumes/kubernetes.io~projected/kube-api-access-pvz7c
tmpfs                                                                         900M   12K  900M   1% /var/lib/kubelet/pods/2f87b09c-ccc4-478f-adef-812213ac8a36/volumes/kubernetes.io~projected/kube-api-access-lqwmc
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/66617372-cbb1-4e1c-b8ea-9b7c20504d48/volumes/kubernetes.io~projected/kube-api-access-28m56
tmpfs                                                                         170M   12K  170M   1% /var/lib/kubelet/pods/57a8c704-52a2-4e65-9d27-a3cfd178df4b/volumes/kubernetes.io~projected/kube-api-access-2cgcq
tmpfs                                                                          32G   12K   32G   1% /var/lib/kubelet/pods/93968586-0f89-4b5c-ad23-8cae3c2f2aca/volumes/kubernetes.io~projected/kube-api-access-2p4kg
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/28280d84aef98fa8acccb301cafd68bfdfd43ed12582c07df282a8addee59c0f/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/28280d84aef98fa8acccb301cafd68bfdfd43ed12582c07df282a8addee59c0f/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/6268c5f156112b087f7ca9d61cb9f221f892886b23754ac8d4b49b1078eb99cb/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6268c5f156112b087f7ca9d61cb9f221f892886b23754ac8d4b49b1078eb99cb/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e55ef465ad3c9f6d419dae1f3289b768a2d803f75abd4cf1bc189eb47c4c5b29/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/6dc51e551a54cc1835bb5a839a7cbfb2fd8d224c8671581957fb5cb720f8e4a8/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/01342dae11d8b73cc9afa6adc9953218c5c19d730db10bcfe74a7ff8d41879e0/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01342dae11d8b73cc9afa6adc9953218c5c19d730db10bcfe74a7ff8d41879e0/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/f2f951529cd482a35651ef4fcb73a048eb2ecf526ca5d333f398a4ecac00d37b/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/de311a964abcffb4224cd3a29f10b43d0ccb177a3d8a2f0b897ff5a332755a1c/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/388ca5f7d217605320511120a6949f8ab74c590c07f0e976c20181042b313ced/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/388ca5f7d217605320511120a6949f8ab74c590c07f0e976c20181042b313ced/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/5c71c17ff23d780c9322cfa60b8ee51128dc7245feaf737afbbdc7eba99b1eab/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/5c71c17ff23d780c9322cfa60b8ee51128dc7245feaf737afbbdc7eba99b1eab/rootfs
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/ff7607143a3295b26c9af3700031403497f50c66df112bca1094a6370b019e93/shm
shm                                                                            64M     0   64M   0% /run/k3s/containerd/io.containerd.grpc.v1.cri/sandboxes/1820e0eff0bea058aa7d589dd2197971460f0406207cd61957e695ceea4ae9b8/shm
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6dc51e551a54cc1835bb5a839a7cbfb2fd8d224c8671581957fb5cb720f8e4a8/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/f2f951529cd482a35651ef4fcb73a048eb2ecf526ca5d333f398a4ecac00d37b/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/de311a964abcffb4224cd3a29f10b43d0ccb177a3d8a2f0b897ff5a332755a1c/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ff7607143a3295b26c9af3700031403497f50c66df112bca1094a6370b019e93/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/1820e0eff0bea058aa7d589dd2197971460f0406207cd61957e695ceea4ae9b8/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e47a6a60ffbdf00abdde84503dea32bcb2a338b4f474452944ec103b24f21e71/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ab58460d4e499c6f4294f56c6dfebd711ea8886ed5c9d69453156b2ca1c39848/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/38e4ea06f8397f349ee7ea05aed3670035fca9958735b08d7bef51f0a6ed707c/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6c43b2c51719b6c25db60476ccdfac85e6ed94daf6511fcdda4a215b26710406/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/cdeb02130c4a4b23acca675432a7e74027a2cf9214ce924de8f00ad4acdc73c7/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/fa7d0468c27b32abc6e876c6bec91f9181738ca82837186be9c74a11fb8ad290/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/35373a1f6a145380feb87d0a81beacd954f6fb86f43cb5a7e9fe9f826839483e/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/52b0d3254035c42327254f592eaa6fb6eaa9fee34b351f12ddd217d095f3f232/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/7dc741f88100aecf790f42f83d963c6ed88a0b2f8fe8cc31854388ff5fe467eb/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/20af61783a51b9e18edbe3720969419ff077d444223a2ef0d0cd934506f6454d/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/1544ebf7edfd89416ce4e7a5038c07c2bacca052fb8d17612d4d02cbeea105c7/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/681ac54ba132e911e00a607d977dce307bfa9e3e445fae14a7af58d1179fb608/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9dcc87ee26c4d7a0a8dd6580625b10b9d2428d59f9b2fa77ad4de5b7ab00c093/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/1eebb154ec49c23dd903b8cb6aead10a239d6a58933b2b172a97f1cdc8bac4ee/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/021a3c5b7fed47554141e69677cfe15f0e23feca001a8f34aa2319555e35bbbc/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/105a5bec04f1709c3344b6659cb79b0331f488071366c559e7180a318b3ebc2f/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/506a464c73387f77d3362a5fa0317af42cd050d99451a531d9e4bf6c7f979623/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/56ba9ae7065bd0a96d9c31625602485343d075413c444e773292db666b1f9e51/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/687664c77acce1f6f129942800317981dbae400e09242ea0eecb3d65818a399f/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/007113130b278faf75c2413f6ba9396b16d3cc31aafc352682684840945d65fa/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/badd5c7ecaad5398bfdc7cc319d4f38954710d44c46807670afca20eb5f8272d/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/87ab40c64cbb2717e125d5a7a57e90371cd9a6f2cc2d88e4e6db7d0b7856032f/rootfs
overlay                                                                       512G  8.0G  504G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/4543e18834e2c7b6452f7484575562c0e224ab864a66ad67a80b88401f070b89/rootfs
```
