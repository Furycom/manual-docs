...
_Last generated at_: **2025-11-24T03:00:43.543070+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-24T03:00:43.543070+00:00.
...
> 
> _Generated at_: **2025-11-24T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 2 days, 13 hours, 17 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.02 0.02 0.00 1/562 133604`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 2 days, 13:17,  0 user,  load average: 0.02, 0.02, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       985Mi       1.4Gi       1.8Mi       1.7Gi       2.8Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   11G  6.3G  64% /
> ```
> 
> ## How to refresh this page
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **64.0%** → `OK`
> - Memory usage: **25.4%** → `OK`
> - CPU load (1 min): **0.02** on **2** cores (per-core: **0.01**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-24T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 5 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.01 0.00 1/372 2305063`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 12 days, 13:36,  1 user,  load average: 0.00, 0.01, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       3.0Gi       536Mi       444Ki       4.5Gi       4.7Gi
> Swap:           23Gi       6.7Gi        17Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   45G  5.7G  89% /
> ```
> 
...
> 
> _Generated at_: **2025-11-24T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-24T03:00:43**
> 
> 
...
> 	+ `mcp-gateway`: up for 2 days
> 	+ `code-server`: up for 2 days
> 	+ `netdata`: up for 2 days (healthy)
> 	+ `dashy`: up for 2 days (healthy)
> 	+ `portainer`: up for 2 days
> * Important metrics:
> 	+ Disk usage on `/`: 64.0% (OK)
> 	+ Memory usage: 25.4% (OK)
> 	+ CPU load (1 min): 0.02 on 2 cores (per-core: 0.01) (OK)
> * Anomalies and errors:
> 	+ Root filesystem usage is high at 64%
> 	+ Root filesystem usage on furyai is high at 89%
> * Upcoming tasks:
> 	+ Review root filesystem usage to prevent potential issues
> 	+ Consider increasing disk space or optimizing file system usage
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 12 days|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 12 days (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 12 days (healthy)|| |
...
RZ1-5TB-4X                                                                    4.27T   907G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.26T   907G  4.26T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.22G   907G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   907G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                8.05G   907G  8.05G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                         907K   907G   907K  legacy
RZ1-5TB-4X/ix-applications/releases                                           65.7M   907G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/mineos                                     750K   907G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/mineos
RZ1-5TB-4X/ix-applications/releases/mineos/charts                              320K   907G   320K  /mnt/RZ1-5TB-4X/ix-applications/releases/mineos/charts
RZ1-5TB-4X/ix-applications/releases/mineos/volumes                             279K   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/mineos/volumes
RZ1-5TB-4X/ix-applications/releases/mineos/volumes/ix_volumes                  140K   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/mineos/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               64.8M   907G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   907G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       64.2M   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            64.0M   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     63.7M   907G  43.2M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   907G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           590M   907G   590M  /mnt/RZ1-5TB-4X/minecraft
RZ2-11TB-6X                                                                   8.58T  2.19T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.58G  2.19T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   113M  2.19T   113M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   360M  2.19T   360M  legacy
...
boot-pool                                                                     5.48G  30.4G    24K  none
boot-pool/ROOT                                                                5.43G  30.4G    24K  none
boot-pool/ROOT/13.0-U4                                                        2.58G  30.4G  1.29G  /
boot-pool/ROOT/23.10.2                                                        2.85G  30.4G  2.85G  legacy
...
RZ1-5TB-4X                                                                    908G  256K  908G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.2T  4.3T  908G  83% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications/k3s                                                916G  8.1G  908G   1% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           908G  110M  908G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases                                           908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        908G  512K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  908G  256K  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     908G   44M  908G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  360M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        908G  1.0M  908G   1% /var/lib/kubelet
tmpfs                                                                         3.2G     0  3.2G   0% /run/user/0
RZ1-5TB-4X/minecraft                                                          908G  591M  908G   1% /mnt/RZ1-5TB-4X/minecraft
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b6cf8af89850fdb2946ab3402b8641750a67feec6de0838c4fb10b0cf05e4057/rootfs
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/28280d84aef98fa8acccb301cafd68bfdfd43ed12582c07df282a8addee59c0f/rootfs
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6268c5f156112b087f7ca9d61cb9f221f892886b23754ac8d4b49b1078eb99cb/rootfs
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e55ef465ad3c9f6d419dae1f3289b768a2d803f75abd4cf1bc189eb47c4c5b29/rootfs
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01342dae11d8b73cc9afa6adc9953218c5c19d730db10bcfe74a7ff8d41879e0/rootfs
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/388ca5f7d217605320511120a6949f8ab74c590c07f0e976c20181042b313ced/rootfs
...
overlay                                                                       916G  8.1G  908G   1% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io