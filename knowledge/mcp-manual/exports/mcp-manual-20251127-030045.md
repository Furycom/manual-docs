...
_Last generated at_: **2025-11-27T03:00:45.523781+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-27T03:00:45.523781+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 5 days | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
...
> 
> _Generated at_: **2025-11-27T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 5 days, 13 hours, 17 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/565 285755`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 5 days, 13:17,  0 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.0Gi       1.1Gi       1.8Mi       2.0Gi       2.8Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **66.0%** → `OK`
> - Memory usage: **26.3%** → `OK`
> - CPU load (1 min): **0.00** on **2** cores (per-core: **0.00**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-27T03:00:05**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 1 day, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/364 2792402`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:03 up 15 days, 13:36,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.9Gi       334Mi       452Ki       4.7Gi       4.8Gi
...
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   46G  5.5G  90% /
> ```
> 
...
> 
> _Generated at_: **2025-11-27T03:00:06**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-27T03:00:45**
> 
> 
...
> 	+ `mcp-gateway`: Up 5 days
> 	+ `code-server`: Up 5 days
> 	+ `mcp-shell`: Up 5 days
> 	+ `portainer`: Up 5 days
> 	+ `netdata`: Up 5 days (healthy)
> 	+ `dashy`: Up 5 days (healthy)
> * **Important Stacks**:
> 	+ MCP Gateway VM: Running for 5 days with 2 CPU cores, 3.8GiB RAM, and 19G root filesystem.
> 	+ furyai AI / GPU box: Running for 2 weeks with 4 CPU cores, 7.7GiB RAM, and 54G root filesystem.
> * **Anomalies**:
> 	+ Root filesystem usage on MCP Gateway VM: 66% used (OK).
> 	+ Root filesystem usage on furyai AI / GPU box: 90% used (warning?).
> * **System Information**:
> 	+ CPU load on MCP Gateway VM: 0.00.
> 	+ Memory usage on MCP Gateway VM: 26.3%.
> 	+ Load average on furyai AI / GPU box: 0.00.
> 
> Note: I did not highlight any errors as there are no error messages in the provided status pages.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| `ollama` | `ollama/ollama:0.12.10` | Up 2 weeks (healthy)|| |
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:05:40 with 0 errors on Mon Nov 24 03:50:42 2025
config:
...
RZ1-5TB-4X                                                                    4.50T   667G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.28T   667G  4.28T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.06G   667G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   667G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.90G   667G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        1.20M   667G  1.20M  legacy
RZ1-5TB-4X/ix-applications/releases                                           58.8M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               58.7M   667G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   667G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.1M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            57.9M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.6M   667G  36.7M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   667G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   881G  5.28G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   371M  2.19T   371M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.19T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.19M  2.19T  1.36M  legacy
...
RZ1-5TB-4X                                                                    667G  256K  667G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.3T  667G  87% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications/k3s                                                675G  7.9G  667G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           667G  110M  667G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases                                           667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        667G  512K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  667G  256K  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     667G   37M  667G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  371M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        667G  1.3M  667G   1% /var/lib/kubelet
tmpfs                                                                         3.2G     0  3.2G   0% /run/user/0
RZ1-5TB-4X/minecraft                                                          668G  908M  667G   1% /mnt/RZ1-5TB-4X/minecraft
...
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b6cf8af89850fdb2946ab3402b8641750a67feec6de0838c4fb10b0cf05e4057/rootfs
...
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/28280d84aef98fa8acccb301cafd68bfdfd43ed12582c07df282a8addee59c0f/rootfs
...
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6268c5f156112b087f7ca9d61cb9f221f892886b23754ac8d4b49b1078eb99cb/rootfs
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e55ef465ad3c9f6d419dae1f3289b768a2d803f75abd4cf1bc189eb47c4c5b29/rootfs
...
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01342dae11d8b73cc9afa6adc9953218c5c19d730db10bcfe74a7ff8d41879e0/rootfs
...
overlay                                                                       675G  7.9G  667G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io