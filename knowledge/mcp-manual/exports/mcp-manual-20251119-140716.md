...
_Generated at (UTC): 2025-11-19T14:07:16.749314+00:00_

Included Markdown pages (relative to `docs/`):
...
- `operations/homelab-journal.md`
- `operations/homelab-prompt.md`
- `operations/using-manual-from-llm.md`
...
- `stacks/mcp-stack.md`
- `vms/homeassistant-vm.md`
- `vms/mcp-gateway-vm.md`
- `vms/n8n-vm.md`
- `vms/proxmox-vms.md`
- `vms/rotki-vm.md`
- `vms/supabase-vm.md`
...
_Last generated at_: **2025-11-19T14:07:16.699994+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T14:07:16.699994+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 18 minutes | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
...
> 
> _Generated at_: **2025-11-19T14:06:34**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 14 hours, 35 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.44 0.19 0.07 1/565 490545`
> 
> ## Uptime (raw)
> 
> ```text
> 14:06:34 up 3 days, 14:35,  2 users,  load average: 0.44, 0.19, 0.07
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> - Memory usage: **25.5%** → `OK`
> - CPU load (1 min): **0.44** on **2** cores (per-core: **0.22**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-19T14:06:39**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 42 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/362 1563418`
> 
> ### Uptime (raw)
> 
> ```text
> 14:06:36 up 8 days, 42 min,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-19T14:07:16**
> 
> 
...
> 	+ MCP Gateway VM: up 3 days, CPU load average: 0.44, memory usage: 25.5%
> 	+ furyai (AI/GPU box): up 8 days, CPU load average: 0.00, memory usage: 45% on 54G root filesystem
> 	+ Code-server container: running on MCP Gateway VM, accessible at http://localhost:8080
> 	+ Dashy and netdata containers: running on MCP Gateway VM, providing system monitoring
> * Anomalies, errors or things that may require attention soon:
> 	+ Root filesystem usage on MCP Gateway VM is 63%, close to the 80% threshold
> 	+ furyai's root filesystem usage is 89%, above the recommended 75% threshold
> * Other notable information:
> 	+ `mcp-manual` container: running and serving documentation at http://localhost:8181
> 	+ Portainer container: running and accessible at http://localhost:9443
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.89M   960G  2.89M  legacy
