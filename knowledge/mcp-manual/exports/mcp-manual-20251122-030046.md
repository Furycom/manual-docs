...
_Last generated at_: **2025-11-22T03:00:45.972280+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-22T03:00:45.972280+00:00.
...
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 13 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 13 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 13 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 13 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 13 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-11-22T03:00:03**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 13 hours, 17 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.02 0.00 1/569 32242`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:03 up 13:17,  1 user,  load average: 0.00, 0.02, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       968Mi       1.6Gi       1.8Mi       1.5Gi       2.9Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   11G  6.4G  63% /
> ```
> 
> ## How to refresh this page
> 
...
> 
> _Generated at_: **2025-11-22T03:00:08**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 3 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/364 1980266`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:05 up 10 days, 13:36,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.9Gi       1.1Gi       440Ki       3.9Gi       4.8Gi
...
> 
> _Generated at_: **2025-11-22T03:00:09**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-22T03:00:45**
> 
> 
...
> 
> * **MCP VM**: 13 hours uptime, all services running smoothly.
> * `mcp-manual`: Running, accessible on port 8181.
> * `mcp-gateway`: Running, accessible on port 4000.
> * `code-server`: Running, accessible on port 8080.
> * `mcp-shell`: Running, accessible on port 7681.
> * `portainer`: Running, accessible on port 9443.
> * `netdata`: Healthy, reporting CPU and memory usage.
> * `dashy`: Healthy, monitoring system resources.
> * **furyai**: 10 days uptime, all services running smoothly.
> * Docker containers: All expected containers are up and running (code-server, mcp-gateway, dashy, netdata, portainer).
> * Disk usage on `/` : 63.0% used, OK.
> * Memory usage: 24.9% used, OK.
> * No major issues detected based on current thresholds.
> * Uptime: 13 hours for MCP VM and 10 days for furyai.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 10 days|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 10 days (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 10 days (healthy)|| |
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.17M   960G  3.17M  legacy
RZ1-5TB-4X/ix-applications/releases                                           64.8M   960G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               64.6M   960G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       64.0M   960G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            63.9M   960G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     63.5M   960G  43.1M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   374M  2.19T   374M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.19T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.08M  2.19T  1.25M  legacy
...
RZ2-11TB-6X/HomeAsistant_dataset                                              86.6G  2.19T   208K  /mnt/RZ2-11TB-6X/HomeAsistant_dataset
RZ2-11TB-6X/HomeAsistant_dataset/haos_zvol                                    86.6G  2.25T  21.9G  -
...
boot-pool/ROOT                                                                5.47G  30.4G    24K  none
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     960G   44M  960G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  374M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        960G  3.3M  960G   1% /var/lib/kubelet
