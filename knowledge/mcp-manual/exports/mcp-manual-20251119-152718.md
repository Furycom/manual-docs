...
Generated at: 2025-11-19T15:27:18Z
...
_Last generated at_: **2025-11-19T15:27:18.768551+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T15:27:18.768551+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up About an hour | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 26 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 26 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 26 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 44 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 44 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 44 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-11-19T15:26:37**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 15 hours, 55 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/560 494469`
> 
> ## Uptime (raw)
> 
> ```text
> 15:26:37 up 3 days, 15:55,  2 users,  load average: 0.00, 0.00, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       983Mi       1.1Gi       1.1Mi       2.0Gi       2.8Gi
...
> 
> _Generated at_: **2025-11-19T15:26:41**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 2 hours, 2 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.02 0.01 1/371 1574272`
> 
> ### Uptime (raw)
> 
> ```text
> 15:26:39 up 8 days,  2:02,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-19T15:26:42**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-19T15:27:18**
> 
> 
...
> 	+ `mcp-gateway` (26 hours uptime) and `code-server` (26 hours uptime)
> 	+ `netdata` (44 hours uptime, healthy) and `dashy` (44 hours uptime, healthy)
> 	+ `portainer` (44 hours uptime)
> * Memory usage: 25.5% (OK)
> * Disk usage on `/`: 63.0% (OK)
> * CPU load: 0.00 on 2 cores (per-core: 0.00) → OK
> * Important container statuses:
> 	+ `mcp-manual` (Up About an hour)
> 	+ `furyai` status reported no issues, but disk usage is high at 89%
> 	+ Docker containers on furyai:
> 		- `cloudflared` and `ollama`: Up 8 days
> 		- `openwebui`: Up 8 days (healthy)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
<!-- BEGIN FILE: operations/manual-exports.md -->
...
<!-- END FILE: operations/manual-exports.md -->
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.94M   960G  2.94M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   369M  2.18T   369M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  370M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
