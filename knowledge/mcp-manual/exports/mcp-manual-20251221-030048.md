...
_Last generated at_: **2025-12-21T03:00:48.732661+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-21T03:00:48.732661+00:00.
...
> 
> _Generated at_: **2025-12-21T03:00:06**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 7 hours, 43 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.49 0.24 0.19 1/717 56891`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:06 up  7:43,  1 user,  load average: 0.49, 0.24, 0.19
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.2Gi       1.6Gi       536Ki       1.3Gi       2.6Gi
> Swap:          3.8Gi       253Mi       3.6Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   37G   19G   16G  54% /
> ```
> 
> ## How to refresh this page
> 
...
> 
> _Generated at_: **2025-12-21T03:00:07**
> 
> 
> ## Summary
> 
...
> - CPU load (1 min): **0.49** on **2** cores (per-core: **0.24**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-21T03:00:11**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 day, 2 hours, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.22 0.09 0.08 1/364 258915`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:08 up 1 day,  2:48,  2 users,  load average: 0.22, 0.09, 0.08
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       1.7Gi       309Mi       4.9Mi       6.0Gi       6.0Gi
...
> 
> _Generated at_: **2025-12-21T03:00:12**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-21T03:00:48**
> 
> 
...
> * **Health:** OK
> * **Services:**
> 	+ `mcp-gateway`: Running on port 4000
> 	+ `code-server`: Running on port 8080
> 	+ `netdata`: Healthy and running on port 19999
> 	+ `dashy`: Healthy and running on port 9090
> * **Anomalies:**
> 	+ Disk usage on `/` is at 54% ( warning threshold not specified)
> 	+ CPU load average is 0.49 (okay for a 2-core system)
...
> 	+ `uptime-kuma`
> 	+ `portainer`
> 	+ `cloudflared` on furyai
> 	+ `dozzle-agent` on furyai
> 	+ `ollama` on furyai
> 	+ `openwebui` on furyai
> * **System status:**
> 	+ Hostname: `furymcp`
...
> 	+ CPU cores: 2
> 	+ Load average: 0.49, 0.24, 0.19 (okay for a 2-core system)
> * **System resources:**
> 	+ Memory usage: 30.8% (okay)
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 27 hours|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 27 hours|| |
| `ollama` | `d353379de60a` | Up 27 hours (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 27 hours (healthy)|| |
...
RZ1-5TB-4X                                                                    4.68T   489G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.45T   489G  4.45T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.06G   489G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   489G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   489G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.90G   489G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                         907K   489G   907K  legacy
RZ1-5TB-4X/ix-applications/releases                                           60.0M   489G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               59.9M   489G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   489G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       59.3M   489G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            59.1M   489G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.8M   489G  38.0M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   489G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   489G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   697G  11.9G  -
RZ2-11TB-6X                                                                   8.58T  2.19T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.59G  2.19T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   116M  2.19T   116M  legacy
...
RZ1-5TB-4X                                                                    490G  256K  490G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.5T  490G  91% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          491G  908M  490G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/catalogs                                           490G  110M  490G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                    490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                498G  7.9G  490G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        490G  512K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  490G  256K  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     490G   38M  490G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  117M  2.2T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        490G  1.0M  490G   1% /var/lib/kubelet
...
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6b5c2a01847084d875840dc39d3919ca301ab1fd9182cce6ab31be09cbe5ef3b/rootfs
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ef0d18e2603c80978de30f1f84dff323bc4409337caa9a14365fb0384f65cb2a/rootfs
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/747a07f6c763ecf2a30c62ab79486dd1588d2d68e76caafc8ba76b0f10b1ee03/rootfs
...
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/f1cdf0c102c83ff88f4b25cf3f2c36c07dae6cfece1dd6ae5854c2bc4d53a3ec/rootfs
...
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/13a16bf814bdaa33830ecfc4a0667ab65a3e8cb4b9f492f12d8fb0eea44d6fc0/rootfs
overlay                                                                       498G  7.9G  490G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io