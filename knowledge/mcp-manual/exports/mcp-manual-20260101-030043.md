...
_Last generated at_: **2026-01-01T03:00:43.559125+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-01T03:00:43.559125+00:00.
...
> | `ntopng` | `ntop/ntopng:latest` | Up 11 days | `-` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 11 days | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 11 days | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 11 days (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 11 days | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 11 days | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 11 days | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 11 days (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 11 days (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-01T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 1 week, 4 days, 7 hours, 42 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.16 0.26 0.27 1/765 1960361`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 11 days,  7:42,  1 user,  load average: 0.16, 0.26, 0.27
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.3Gi       1.2Gi       836Mi       240Ki       1.6Gi       2.2Gi
> Swap:          3.8Gi       448Mi       3.4Gi
> ```
> 
...
> 
> _Generated at_: **2026-01-01T03:00:02**
> 
> 
> ## Summary
> 
...
> 
> _Generated at_: **2026-01-01T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 5 days, 2 hours, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.22 0.13 0.10 2/368 2780392`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 12 days,  2:48,  2 users,  load average: 0.22, 0.13, 0.10
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       1.7Gi       440Mi       1.1Mi       5.9Gi       6.0Gi
...
> 
> _Generated at_: **2026-01-01T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-01T03:00:42**
> 
> 
...
> ## Summary
> 
> Here is a concise daily summary of Yann's homelab MCP environment in English:
> 
> * **Overall health:** OK
> 	+ No major issues detected based on current thresholds.
> 	+ All required containers are running and healthy.
> * **Running services:**
> 	+ `mcp-manual` (Docs) - Running for 24 hours
> 	+ `dozzle-agent` (Logging) - Running for 2 days
> 	+ `ntopng` (Network monitoring) - Running for 11 days
> 	+ `code-server` (IDE) - Running for 11 days
> * **Anomalies and errors:**
> 	+ None reported in the status pages.
> * **Important upcoming events:**
> 	+ Regular maintenance schedule not specified.
> 	+ No known issues or alerts.
> * **System resources:**
> 	+ Disk usage on `/`: 56.0% (OK)
> 	+ Memory usage: 35.2% (OK)
> 	+ CPU load (1 min): 0.16 on 2 cores (per-core: 0.08) (OK)
> * **furyai status:** 
> 	+ System information: Hostname `furycomai`, uptime 12 days, CPU cores 4, Load average 0.22
> 	+ Uptime (raw): up 12 days, load average: 0.22, 0.13, 0.10
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| `dozzle-agent` | `amir20/dozzle:latest` | Up 12 days|| |
| `ollama` | `d353379de60a` | Up 12 days (healthy)|| |
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.13M   353G  3.13M  legacy
RZ1-5TB-4X/ix-applications/releases                                           60.9M   353G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               60.8M   353G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       60.2M   353G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            60.0M   353G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     59.7M   353G  38.8M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        354G  3.3M  354G   1% /var/lib/kubelet
