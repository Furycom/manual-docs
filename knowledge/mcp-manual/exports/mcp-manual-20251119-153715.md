...
_Last generated at_: **2025-11-19T15:37:15.363561+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T15:37:15.363561+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 9 minutes | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
...
> 
> _Generated at_: **2025-11-19T15:36:33**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 16 hours, 5 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.02 0.00 1/562 495115`
> 
> ## Uptime (raw)
> 
> ```text
> 15:36:33 up 3 days, 16:05,  2 users,  load average: 0.00, 0.02, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       989Mi       1.1Gi       1.1Mi       2.0Gi       2.8Gi
...
> 
> _Generated at_: **2025-11-19T15:36:37**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 2 hours, 12 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.09 0.04 0.01 1/361 1575774`
> 
> ### Uptime (raw)
> 
> ```text
> 15:36:35 up 8 days,  2:12,  1 user,  load average: 0.09, 0.04, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-19T15:36:38**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-19T15:37:15**
> 
> 
...
> * **Overall Health:** OK
> * **Running Services:**
> 	+ `mcp-gateway`: up 26 hours
> 	+ `code-server`: up 26 hours
> 	+ `netdata`: up 44 hours (healthy)
> 	+ `dashy`: up 44 hours (healthy)
> 	+ `portainer`: up 44 hours
> * **Important Containers:**
> 	+ `mcp-manual`: up 9 minutes (updated recently)
> * **Anomalies/Errors:**
> 	+ `/` root filesystem usage: 63.0% (OK)
> 	+ Memory usage: 25.4% (OK)
> 	+ No major issues detected
> * **Uptime:**
> 	+ MCP VM: up 3 days, 16 hours, 5 minutes
> 	+ furyai: up 8 days, 2 hours, 12 minutes
> * **Disk Usage:**
> 	+ `/` root filesystem usage: 63.0% (OK)
> 	+ furyai: 89% used
> 
