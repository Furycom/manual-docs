...
_Last generated at_: **2026-01-12T03:00:42.115841+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-12T03:00:42.115841+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 14 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 14 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 14 hours | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 14 hours | `-` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 14 hours | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 3 hours (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 14 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 14 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 14 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 14 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 14 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-12T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 13 hours, 38 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.31 0.23 0.24 1/763 130647`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 13:38,  1 user,  load average: 0.31, 0.23, 0.24
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           2.9Gi       1.2Gi       442Mi       296Ki       1.6Gi       1.7Gi
> Swap:          3.8Gi       423Mi       3.4Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   37G   20G   15G  58% /
> ```
> 
> ## How to refresh this page
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **58.0%** → `OK`
> - Memory usage: **40.5%** → `OK`
> - CPU load (1 min): **0.31** on **2** cores (per-core: **0.15**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-12T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 day, 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.40 0.14 0.10 2/370 331337`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 1 day, 12:28,  2 users,  load average: 0.09, 0.07, 0.08
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.3Gi       1.1Gi       4.9Mi       4.6Gi       5.4Gi
> Swap:           23Gi       1.0Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   31G   20G  62% /
> ```
> 
...
> 
> _Generated at_: **2026-01-12T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-12T03:00:41**
> 
> 
...
> ## Summary
> 
> Here is the concise daily summary in English using bullet points:
> 
> * Overall health: **OK** - No major issues detected based on current thresholds.
> * Running services:
> 	+ `mcp-gateway` and `code-server` are up and running for 14 hours.
> 	+ `uptime-kuma` has been up for 3 hours, showing a healthy status.
> 	+ `netdata`, `dashy`, and `portainer` have been up for 14 hours with healthy statuses.
> * Anomalies or errors:
> 	+ None reported in the health reports.
> * Important stacks:
> 	+ MCP Gateway VM is running smoothly with all containers up.
> 	+ furyai (AI/GPU box) has 4 CPU cores, with a load average of 0.40 and sufficient memory usage.
> * Things that may require attention soon:
> 	+ `mcp-shell` is not required but still up, might be removed if unnecessary.
> 	+ Disk usage on the MCP Gateway VM root filesystem is at **58%**, which might become a concern soon.
> 	+ furyai's root filesystem is at **62%** usage, also approaching a potential issue.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 36 hours (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 34 hours|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 36 hours|| |
| `ollama` | `d353379de60a` | Up 36 hours (healthy)|| |
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:31 with 0 errors on Mon Jan  5 03:54:34 2026
config:
...
RZ1-5TB-4X                                                                    4.75T   412G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.53T   412G  4.53T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.07G   412G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   412G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.90G   412G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.02M   412G  2.02M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.0M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               58.9M   412G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   412G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.2M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.1M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.7M   412G  36.9M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   412G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   619G  12.5G  -
RZ2-11TB-6X                                                                   8.50T  2.27T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.60G  2.27T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   118M  2.27T   118M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   373M  2.27T   373M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.27T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.20M  2.27T  1.37M  legacy
...
RZ1-5TB-4X                                                                    413G  256K  413G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.6T  413G  92% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          414G  908M  413G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/k3s                                                421G  8.0G  413G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           413G  110M  413G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        413G  512K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  413G  256K  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     413G   37M  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ2-11TB-6X/.system                                                           2.3T  2.1G  2.3T   1% /var/db/system
RZ2-11TB-6X/.system/cores                                                     1.0G  256K  1.0G   1% /var/db/system/cores
RZ2-11TB-6X/.system/samba4                                                    2.3T  1.4M  2.3T   1% /var/db/system/samba4
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  119M  2.3T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  374M  2.3T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        413G  2.2M  413G   1% /var/lib/kubelet
...
overlay                                                                       421G  8.0G  413G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b07a5e322946aad6dd5567c2f3c757c6e256b45ae5d2cc03cf988df5464106d2/rootfs
overlay                                                                       421G  8.0G  413G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/59aee8af3b0b522f7801a406d73b9a854bf696581f658a472daccf2a95b25bb3/rootfs
overlay                                                                       421G  8.0G  413G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01f0b33e711abc2c0f37437c676f407a2d69512d53c7cc22ad1cc8327e26f67e/rootfs
overlay                                                                       421G  8.0G  413G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/223a048ea6b44b9d1b658003b3440b034c7c5c8af28f30c39efe7603d567a93d/rootfs
...
overlay                                                                       421G  8.0G  413G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io