...
_Last generated at_: **2025-12-06T03:00:54.005477+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-06T03:00:54.005477+00:00.
...
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 4 days | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 47 hours | `-` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 5 days (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 5 days | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 5 days | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 5 days | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 5 days (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 5 days (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-12-06T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 5 days, 7 hours, 0 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.16 0.25 0.40 1/737 997436`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 5 days,  7:00,  3 users,  load average: 0.16, 0.25, 0.40
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           7.6Gi       1.6Gi       591Mi       2.1Mi       5.8Gi       6.1Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   17G  113M 100% /
> ```
> 
> ## How to refresh this page
> 
...
> ## Summary
> 
> ⚠️ Issues detected: disk usage crit (100.0%)
> 
> ### Metrics overview
> 
> - Disk usage on `/`: **100.0%** → `CRIT`
> - Memory usage: **20.8%** → `OK`
> - CPU load (1 min): **0.16** on **2** cores (per-core: **0.08**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-06T03:00:05**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 3 weeks, 3 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.05 0.02 0.00 1/364 362392`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:03 up 24 days, 13:36,  2 users,  load average: 0.05, 0.02, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.7Gi       494Mi       532Ki       4.8Gi       5.0Gi
> Swap:           23Gi       6.0Gi        17Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2025-12-06T03:00:06**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-06T03:00:53**
> 
> 
...
> ## Summary
> 
> Here is the daily MCP summary in bullet points:
> 
> * **Overall health**: OK (minor warnings)
> 	+ Disk usage on `/` is 100% (CRIT)
> * **Running services**:
> 	+ `mcp-manual`: UP (24 hours)
> 	+ `mcp-gateway`: UP (2 days)
> 	+ `code-server`: UP (5 days)
> 	+ `portainer`: UP (5 days)
> 	+ `netdata`: UP and healthy (5 days)
> 	+ `dashy`: UP and healthy (5 days)
> * **Important stacks**:
> 	+ MCP Gateway: up 2 days
> 	+ Termix: up 4 days
> 	+ Ntopng: up 47 hours
> * **Anomalies/Errors**:
> 	+ Disk usage on `/` is critical (100%)
> 	+ `mcp-gateway`: no errors reported, but disk usage is a concern
> 	+ `uptime-kuma`: healthy for 5 days, but not reporting any issues
> * **Important nodes**:
> 	+ furyai: up 3 weeks, 3 days, 13 hours, 36 minutes (runtime & system status OK)
> 	+ furymcp: up 5 days, 7 hours, 0 minutes (system status OK)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| `ollama` | `ollama/ollama:0.12.10` | Up 5 days (healthy)|| |
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.75M   651G  2.75M  legacy
...
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   860G  10.3G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   365M  2.19T   365M  legacy
...
boot-pool                                                                     8.56G  27.3G    24K  none
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  366M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        651G  2.9M  651G   1% /var/lib/kubelet
