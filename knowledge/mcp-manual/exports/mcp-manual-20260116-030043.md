...
_Last generated at_: **2026-01-16T03:00:43.075309+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-16T03:00:43.075309+00:00.
...
> |------|-------|--------|-------|
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 13 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 24 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 4 days | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 4 days | `-` |
...
> 
> _Generated at_: **2026-01-16T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 4 days, 13 hours, 38 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.62 0.43 0.32 1/767 1072258`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 4 days, 13:38,  2 users,  load average: 0.62, 0.43, 0.32
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.2Gi       1.2Gi       692Mi       664Ki       1.7Gi       2.1Gi
> Swap:          3.8Gi       516Mi       3.3Gi
> ```
> 
...
> 
> _Generated at_: **2026-01-16T03:00:02**
> 
> 
> ## Summary
> 
...
> - Memory usage: **36.6%** → `OK`
> - CPU load (1 min): **0.62** on **2** cores (per-core: **0.31**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-16T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 5 days, 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.17 0.11 0.09 1/369 1274328`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 5 days, 12:28,  2 users,  load average: 0.19, 0.11, 0.09
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.1Gi       918Mi       3.6Mi       5.0Gi       5.6Gi
> Swap:           23Gi       718Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2026-01-16T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-16T03:00:42**
> 
> 
...
> 
> * **Health**: OK - No major issues detected based on current thresholds.
> * **Running services**:
> 	+ `mcp-gateway` and `code-server`: Up for 4 days
> 	+ `mcp-manual`, `dashy`, `netdata`, `portainer`, and `uptime-kuma`: Up for 4 days (healthy)
> 	+ `termix` and `ntopng`: Up for 4 days
> * **Important stacks**:
> 	+ MCP VM: All expected containers are running.
> 	+ furyai: SSH connection successful, all containers running.
> * **Anomalies/Errors**: None detected in status pages.
> * **Memory usage**: 36.6% on the MCP VM (OK), 30.3% on furyai (OK).
> * **Disk usage**: 59.0% on the MCP VM's root filesystem (OK), 61.1% on furyai's root filesystem (OK).
> * **Load average**: 0.62, 0.43, 0.32 on the MCP VM (OK), 0.17, 0.11, 0.09 on furyai (OK).
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 3 days (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 5 days|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 5 days|| |
| `ollama` | `d353379de60a` | Up 2 days (healthy)|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdl2                                ONLINE       0     0     0
	    sdj2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     0     0   127  too many errors
...
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   412G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.30M   412G  2.30M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.6M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               59.5M   412G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.9M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.7M   412G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.4M   412G  37.5M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   619G  12.6G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   359M  2.27T   359M  legacy
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     413G   38M  413G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  360M  2.3T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        413G  2.4M  413G   1% /var/lib/kubelet
