...
_Last generated at_: **2025-12-09T03:02:08.145934+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-09T03:02:08.145934+00:00.
...
> |------|-------|--------|-------|
> | `mcp-firestick-adb` | `mcp-firestick-adb-mcp-firestick-adb` | Up 5 hours | `-` |
> | `ntopng` | `ntop/ntopng:latest` | Up 9 hours | `-` |
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 2 days | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
...
> 
> _Generated at_: **2025-12-09T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 2 days, 5 hours, 39 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.63 0.75 0.77 1/748 381571`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 2 days,  5:39,  3 users,  load average: 0.63, 0.75, 0.77
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           7.6Gi       1.5Gi       510Mi       2.2Mi       5.9Gi       6.1Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> - CPU load (1 min): **0.90** on **2** cores (per-core: **0.45**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-09T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 3 weeks, 6 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/363 1047592`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 27 days, 13:36,  3 users,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.7Gi       320Mi       600Ki       5.0Gi       5.0Gi
...
> 
> _Generated at_: **2025-12-09T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-09T03:02:07**
> 
> 
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.08M   602G  3.08M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.4M   602G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.6M   602G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.5M   602G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.1M   602G  37.3M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   812G  10.4G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  377M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        603G  3.2M  603G   1% /var/lib/kubelet
