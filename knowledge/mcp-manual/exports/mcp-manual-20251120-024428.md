...
_Last generated at_: **2025-11-20T02:44:28.588433+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-20T02:44:28.588433+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 11 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
...
> 
> _Generated at_: **2025-11-20T02:43:46**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 4 days, 3 hours, 12 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/566 520564`
> 
> ## Uptime (raw)
> 
> ```text
> 02:43:46 up 4 days,  3:12,  2 users,  load average: 0.00, 0.00, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-20T02:43:47**
> 
> 
> ## Summary
> 
...
> 
> _Generated at_: **2025-11-20T02:43:51**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 13 hours, 19 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.02 0.01 2/364 1652031`
> 
> ### Uptime (raw)
> 
> ```text
> 02:43:49 up 8 days, 13:19,  1 user,  load average: 0.08, 0.02, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-20T02:43:52**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-20T02:44:28**
> 
> 
...
> 
> * **Overall health: OK**
> 	+ All 7 containers are running on the MCP Gateway VM.
> 	+ No major issues detected in the MCP health report based on current thresholds.
> * **Running services and stacks:**
> 	+ `mcp-gateway` (38 hours up)
> 	+ `code-server` (38 hours up)
> 	+ `mcp-shell` (38 hours up)
> 	+ `dashy` (2 days up)
> 	+ `netdata` (2 days up)
> 	+ `portainer` (2 days up)
> * **Important services and stacks:**
> 	+ `mcp-manual` (11 hours up) is running, providing manual documentation.
> * **Anomalies or potential issues:**
> 	+ Root filesystem usage on the MCP Gateway VM is at 63% capacity.
> 	+ CPU load on furyai is slightly elevated at 0.08.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   378M  2.18T   378M  legacy
