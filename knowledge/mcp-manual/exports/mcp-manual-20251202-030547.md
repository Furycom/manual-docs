...
_Last generated at_: **2025-12-02T03:05:47.611798+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-02T03:05:47.611798+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 4 minutes | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 7 hours | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 13 hours | `-` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 31 hours (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 31 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 31 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 31 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 31 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 31 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 31 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-12-02T03:05:34**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 1 day, 7 hours, 6 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.37 0.31 0.20 1/729 335654`
> 
> ## Uptime (raw)
> 
> ```text
> 03:05:34 up 1 day,  7:06,  2 users,  load average: 0.37, 0.31, 0.20
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           7.6Gi       1.5Gi       506Mi       2.1Mi       5.9Gi       6.1Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   17G  854M  96% /
> ```
> 
> ## How to refresh this page
> 
...
> ## Summary
> 
> ⚠️ Issues detected: disk usage crit (96.0%)
> 
> ### Metrics overview
> 
> - Disk usage on `/`: **96.0%** → `CRIT`
> - Memory usage: **19.8%** → `OK`
> - CPU load (1 min): **0.37** on **2** cores (per-core: **0.18**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-02T03:05:38**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 6 days, 13 hours, 41 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.08 0.09 0.05 1/376 3639024`
> 
> ### Uptime (raw)
> 
> ```text
> 03:05:36 up 20 days, 13:41,  2 users,  load average: 0.08, 0.09, 0.05
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       3.4Gi       209Mi        32Mi       4.4Gi       4.2Gi
> Swap:           23Gi       6.0Gi        18Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   46G  5.3G  90% /
> ```
> 
...
> 
> _Generated at_: **2025-12-02T03:05:39**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-02T03:05:47**
> 
> 
...
> ## Summary
> 
> Here is a concise daily summary of Yann's homelab MCP environment:
> 
> * **MCP VM status**: OK, all containers up and running.
> 	+ Containers: mcp-manual, termix, ntopng, uptime-kuma, mcp-gateway, code-server, mcp-shell, portainer, netdata, dashy
> * **Disk usage on /** (CRIT): 96.0%
> * **Memory usage**: 19.8% (OK)
> * **CPU load (1 min)**: 0.37 (OK)
> * **Uptime (furymcp)**: up 1 day, 7 hours, 6 minutes
> * **furyai system info**: uptime: 20 days, 13 hours, 41 minutes; CPU cores: 4; Load average: 0.08, 0.09, 0.05
> * **furyai memory usage (CRIT)**: 90% on /
> * **Docker containers on furyai**:
> 	+ cloudflared: up 2 weeks
> 	+ ollama: up 33 hours (healthy)
> 	+ openwebui: up 2 weeks (healthy)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 2 weeks|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 33 hours (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 2 weeks (healthy)|| |
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:54 with 0 errors on Mon Dec  1 03:54:57 2025
config:
...
RZ1-5TB-4X                                                                    4.51T   661G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.28T   661G  4.28T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.07G   661G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   661G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   661G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.90G   661G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.03M   661G  2.03M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.0M   661G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               58.9M   661G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   661G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.2M   661G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.1M   661G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.7M   661G  36.9M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   661G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   661G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   871G  9.77G  -
RZ2-11TB-6X                                                                   8.58T  2.19T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.59G  2.19T  2.04G  legacy
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                   114M  2.19T   114M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   372M  2.19T   372M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.19T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.13M  2.19T  1.30M  legacy
...
RZ1-5TB-4X                                                                    662G  256K  662G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.3T  662G  87% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications/k3s                                                670G  7.9G  662G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           662G  110M  662G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases                                           662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        662G  512K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  662G  256K  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     662G   37M  662G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  114M  2.2T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  372M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        662G  2.2M  662G   1% /var/lib/kubelet
tmpfs                                                                         3.2G     0  3.2G   0% /run/user/0
RZ1-5TB-4X/minecraft                                                          663G  908M  662G   1% /mnt/RZ1-5TB-4X/minecraft
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/b6cf8af89850fdb2946ab3402b8641750a67feec6de0838c4fb10b0cf05e4057/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/28280d84aef98fa8acccb301cafd68bfdfd43ed12582c07df282a8addee59c0f/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6268c5f156112b087f7ca9d61cb9f221f892886b23754ac8d4b49b1078eb99cb/rootfs
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/e55ef465ad3c9f6d419dae1f3289b768a2d803f75abd4cf1bc189eb47c4c5b29/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/01342dae11d8b73cc9afa6adc9953218c5c19d730db10bcfe74a7ff8d41879e0/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/388ca5f7d217605320511120a6949f8ab74c590c07f0e976c20181042b313ced/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/5c71c17ff23d780c9322cfa60b8ee51128dc7245feaf737afbbdc7eba99b1eab/rootfs
...
overlay                                                                       670G  7.9G  662G   2% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io