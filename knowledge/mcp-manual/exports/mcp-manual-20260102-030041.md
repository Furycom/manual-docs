...
_Last generated at_: **2026-01-02T03:00:41.616079+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-02T03:00:41.616079+00:00.
...
> |------|-------|--------|-------|
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 8 hours | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 24 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 12 days | `-` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 12 days | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 12 days | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 12 days (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 12 days | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 12 days | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 12 days | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 12 days (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 12 days (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-02T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 1 week, 5 days, 7 hours, 42 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.14 0.18 0.18 1/761 2139951`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 12 days,  7:42,  1 user,  load average: 0.14, 0.18, 0.18
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.1Gi       1.4Gi       328Ki       1.5Gi       2.7Gi
> Swap:          3.8Gi       454Mi       3.4Gi
> ```
> 
...
> - CPU load (1 min): **0.21** on **2** cores (per-core: **0.10**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-02T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 6 days, 2 hours, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.14 0.06 0.01 1/367 3010097`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 13 days,  2:48,  2 users,  load average: 0.16, 0.07, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       1.7Gi       374Mi       652Ki       5.9Gi       6.0Gi
...
> 
> _Generated at_: **2026-01-02T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-02T03:00:40**
> 
> 
...
> 
> * **System Status**: OK, up for 12 days, 7 hours, and 42 minutes.
> * **Memory Usage**: 29.7% used out of 3.8Gi total, disk usage at 56%.
> * **CPU Load**: Average load is within normal limits (0.14, 0.18, 0.18).
> * **Running Containers**:
> 	+ `mcp-gateway`: Running and healthy.
> 	+ `ntopng`, `termix`, `uptime-kuma`, `code-server`, `netdata`, `dashy`: All running as expected.
> 	+ `portainer`: Running but not essential for MCP functionality.
> * **furyai Status**: OK, up for 13 days with no major issues detected.
> 
> Note: I did not include the "How to refresh this page" sections in the summary.
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 13 days|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 13 days|| |
| `ollama` | `d353379de60a` | Up 13 days (healthy)|| |
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.36` | Up 13 days (healthy)|| |
...
RZ1-5TB-4X                                                                    4.81T   351G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.59T   351G  4.59T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.08G   351G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   351G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   351G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   351G  7.91G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.29M   351G  3.29M  legacy
RZ1-5TB-4X/ix-applications/releases                                           61.3M   351G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               61.2M   351G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   351G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       60.5M   351G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            60.4M   351G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     60.0M   351G  39.2M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   351G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   351G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   558G  12.1G  -
...
boot-pool/ROOT                                                                8.47G  27.4G    24K  none
...
RZ1-5TB-4X                                                                    351G  256K  351G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.6T  351G  94% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          352G  908M  351G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/catalogs                                           351G  110M  351G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                    351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                359G  8.0G  351G   3% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        351G  512K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  351G  256K  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     351G   40M  351G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        351G  3.4M  351G   1% /var/lib/kubelet
...
overlay                                                                       359G  8.0G  351G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6b5c2a01847084d875840dc39d3919ca301ab1fd9182cce6ab31be09cbe5ef3b/rootfs
overlay                                                                       359G  8.0G  351G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ef0d18e2603c80978de30f1f84dff323bc4409337caa9a14365fb0384f65cb2a/rootfs
overlay                                                                       359G  8.0G  351G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/747a07f6c763ecf2a30c62ab79486dd1588d2d68e76caafc8ba76b0f10b1ee03/rootfs
...
overlay                                                                       359G  8.0G  351G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io