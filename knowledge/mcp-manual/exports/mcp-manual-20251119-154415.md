...
_Last generated at_: **2025-11-19T15:44:15.623418+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-19T15:44:15.623418+00:00.
...
> |------|-------|--------|-------|
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 6 minutes | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 27 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 27 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 27 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
...
> 
> _Generated at_: **2025-11-19T15:43:33**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 3 days, 16 hours, 12 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.02 0.07 0.03 1/560 495654`
> 
> ## Uptime (raw)
> 
> ```text
> 15:43:33 up 3 days, 16:12,  2 users,  load average: 0.02, 0.07, 0.03
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> 
> _Generated at_: **2025-11-19T15:43:37**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 1 day, 2 hours, 19 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.16 0.07 0.03 1/361 1577121`
> 
> ### Uptime (raw)
> 
> ```text
> 15:43:35 up 8 days,  2:19,  1 user,  load average: 0.16, 0.07, 0.03
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       3.7Gi       1.2Gi       448Ki       3.1Gi       4.0Gi
...
> 
> _Generated at_: **2025-11-19T15:43:38**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-19T15:44:15**
> 
> 
...
> ## Summary
> 
> Here is the daily MCP summary in a concise format using bullet points:
> 
> * **System Status: OK**
> 	+ Hostname: furymcp
> 	+ Uptime: 3 days, 16 hours, 12 minutes
> 	+ CPU cores: 2
> 	+ Memory usage: 25.4% (OK)
> 	+ Disk usage on /: 63.0% (OK)
> * **Running Services:**
> 	+ `mcp-manual`: Up 6 minutes (running)
> 	+ `mcp-gateway`: Up 27 hours (running)
> 	+ `code-server`: Up 27 hours (running)
> 	+ `mcp-shell`: Up 27 hours (running)
> 	+ `portainer`: Up 44 hours (running)
> 	+ `netdata`: Up 44 hours (healthy, running)
> 	+ `dashy`: Up 44 hours (healthy, running)
> * **Important Stacks:**
> 	+ MCP Gateway VM
> 	+ furyai AI / GPU box (connected via SSH)
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   370M  2.18T   370M  legacy
