...
_Last generated at_: **2025-12-16T03:00:42.662286+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-12-16T03:00:42.662286+00:00.
...
> | `ntopng` | `ntop/ntopng:latest` | Up 32 hours | `-` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 32 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 32 hours | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 4 hours (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 32 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 32 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 32 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 32 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 32 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-12-16T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 1 day, 8 hours, 28 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.32 0.21 0.18 1/719 226105`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 1 day,  8:28,  1 user,  load average: 0.32, 0.21, 0.18
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           2.8Gi       1.2Gi       421Mi       372Ki       1.5Gi       1.6Gi
> Swap:          3.8Gi       279Mi       3.5Gi
> ```
> 
...
> 
> _Generated at_: **2025-12-16T03:00:03**
> 
> 
> ## Summary
> 
...
> - Memory usage: **41.5%** → `OK`
> - CPU load (1 min): **0.32** on **2** cores (per-core: **0.16**) → `OK`
> 
...
> 
> _Generated at_: **2025-12-16T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 3 days, 13 hours, 13 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.01 0.00 1/380 720762`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 3 days, 13:13,  3 users,  load average: 0.00, 0.01, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.4Gi       406Mi       5.1Mi       5.2Gi       5.3Gi
...
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   46G  5.1G  91% /
> ```
> 
...
> 
> _Generated at_: **2025-12-16T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-12-16T03:00:42**
> 
> 
...
> ## Summary
> 
> Here is the daily MCP summary in English with bullet points:
> 
> * **Health status**: OK (all systems online)
> * **Important services**:
> 	+ `mcp-manual`: running and serving documentation
> 	+ `code-server`: running and accessible through web interface
> 	+ `netdata` and `dashy`: running and monitoring system performance
> * **Running containers**:
> 	+ 10 containers are currently up and running on the MCP VM (listed in runtime-status-mcp.md)
> * **System resources**:
> 	+ CPU load average: 0.32 (OK)
> 	+ Memory usage: 41.5% (OK)
> 	+ Disk usage on `/`: 54.0% (OK)
> * **FuryAI status**: 
> 	+ System online and running
> 	+ No major issues detected based on current thresholds (mcp-health-report.md)
> * **Anomalies**:
> 	+ Root filesystem on furyai is almost full (91% used)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `dozzle-agent` | `amir20/dozzle:latest` | Up 7 minutes|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 3 days|| |
| `ollama` | `ollama/ollama:0.12.10` | Up 3 days (healthy)|| |
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:25 with 0 errors on Mon Dec 15 03:54:28 2025
config:
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.97M   504G  3.97M  legacy
RZ1-5TB-4X/ix-applications/releases                                           60.7M   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            59.8M   504G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     59.4M   504G  38.6M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   366M  2.19T   366M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.19T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.16M  2.19T  1.33M  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  367M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        504G  4.0M  504G   1% /var/lib/kubelet
