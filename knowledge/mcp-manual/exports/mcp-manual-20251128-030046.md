...
_Last generated at_: **2025-11-28T03:00:46.540834+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-28T03:00:46.540834+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 6 days | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 6 days | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 6 days | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 6 days | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 6 days (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 6 days (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2025-11-28T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 6 days, 13 hours, 17 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.01 0.00 1/563 341671`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 6 days, 13:17,  0 user,  load average: 0.00, 0.01, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.0Gi       672Mi       1.8Mi       2.4Gi       2.8Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   12G  5.8G  67% /
> ```
> 
> ## How to refresh this page
> 
...
> ### Metrics overview
> 
> - Disk usage on `/`: **67.0%** → `OK`
> - Memory usage: **27.7%** → `OK`
...
> 
> _Generated at_: **2025-11-28T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 2 days, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/365 2965608`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 16 days, 13:36,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.6Gi       259Mi       480Ki       5.1Gi       5.1Gi
> Swap:           23Gi       7.0Gi        17Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
> ```text
> Filesystem                            Size  Used Avail Use% Mounted on
> /dev/mapper/ubuntu--vg--1-ubuntu--lv   54G   46G  4.8G  91% /
> ```
> 
...
> 
> _Generated at_: **2025-11-28T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-28T03:00:46**
> 
> 
...
> 
> * **System Uptime:** up 6 days, 13 hours, 17 minutes (OK)
> * **CPU Load Average:** 0.00 0.01 0.00 (OK)
> * **Memory Usage:** 27.7% used out of 3.8Gi total (OK)
> * **Disk Space on `/`:** 67% used out of 19G total (OK)
> * **Running Containers:**
> 	+ `mcp-manual` (OK)
> 	+ `mcp-gateway` (OK)
> 	+ `code-server` (OK)
...
> 	+ `netdata` (healthy, OK)
> 	+ `dashy` (healthy, OK)
> * **furyai System Uptime:** up 2 weeks, 2 days, 13 hours, 36 minutes (OK)
> * **CPU Load Average on furyai:** 0.00 0.00 0.00 (OK)
> * **Memory Usage on furyai:** 33.8% used out of 7.7Gi total (OK)
> * **Disk Space on `/` on furyai:** 91% used out of 54G total ( warning)
> * **Docker Containers on furyai:**
> 	+ `cloudflared` (Up 2 weeks, OK)
> 	+ `ollama` (Up 2 weeks, healthy, OK)
> 	+ `openwebui` (Up 2 weeks, healthy, OK)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
RZ1-5TB-4X/ix-applications                                                    8.07G   667G   209K  /mnt/RZ1-5TB-4X/ix-applications
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        1.31M   667G  1.31M  legacy
RZ1-5TB-4X/ix-applications/releases                                           58.9M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.0M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.6M   667G  36.8M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   881G  5.37G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.2T  365M  2.2T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        667G  1.4M  667G   1% /var/lib/kubelet
