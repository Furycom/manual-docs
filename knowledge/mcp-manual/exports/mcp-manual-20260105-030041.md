...
_Last generated at_: **2026-01-05T03:00:41.600921+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-05T03:00:41.600921+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 2 weeks | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
...
> 
> _Generated at_: **2026-01-05T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 2 weeks, 1 day, 7 hours, 42 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.00 0.05 0.12 1/762 2677266`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 15 days,  7:42,  1 user,  load average: 0.00, 0.05, 0.12
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.2Gi       1.4Gi       228Ki       1.5Gi       2.6Gi
> Swap:          3.8Gi       466Mi       3.3Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   37G   20G   16G  56% /
> ```
> 
> ## How to refresh this page
> 
...
> 
> _Generated at_: **2026-01-05T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 2 days, 2 hours, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 2/370 3699196`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 16 days,  2:48,  2 users,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       1.7Gi       453Mi       648Ki       5.8Gi       6.0Gi
> Swap:           23Gi       304Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2026-01-05T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-05T03:00:40**
> 
> 
...
> * Overall health: OK
> * Running services:
> 	+ Docker containers: 13 running, including `mcp-manual`, `dozzle-agent`, `ntopng`, and others
> 	+ System metrics: no major issues detected based on current thresholds (disk usage, memory usage, CPU load)
> * Important stacks:
> 	+ MCP Gateway VM: up for 15 days, with stable system and container status
> 	+ furyai AI/GPU box: up for 16 days, with stable system and container status
> * Anomalies/Errors/Attention required soon:
> 	+ `mcp-manual` container has been running for 24 hours (might be worth checking its logs)
> 	+ `dozzle-agent` container on furyai has been running for 2 weeks (might be worth verifying its configuration)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdh2                                ONLINE       0     0     0
	    sdi2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     5 1.11K 1.86K  too many errors
...
action: Consider setting 'compatibility' to an appropriate value, or
  ...
  scan: scrub repaired 0B in 00:09:29 with 0 errors on Mon Dec 29 03:54:31 2025
config:
...
RZ1-5TB-4X                                                                    4.85T   313G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.62T   313G  4.62T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.08G   313G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   313G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   313G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   313G  7.91G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.46M   313G  3.46M  legacy
RZ1-5TB-4X/ix-applications/releases                                           62.0M   313G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               61.8M   313G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   313G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       61.2M   313G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            61.0M   313G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     60.7M   313G  39.9M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   313G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   313G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   520G  12.4G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   380M  2.27T   380M  legacy
...
RZ1-5TB-4X                                                                    313G  256K  313G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.7T  313G  94% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          314G  908M  313G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/catalogs                                           314G  110M  313G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                    313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                321G  8.0G  313G   3% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        313G  512K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  313G  256K  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     314G   40M  313G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  118M  2.3T   1% /var/db/system/configs-cadb1ce96f8c4a01a65be3ef8f5cb996
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        313G  3.5M  313G   1% /var/lib/kubelet
...
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6b5c2a01847084d875840dc39d3919ca301ab1fd9182cce6ab31be09cbe5ef3b/rootfs
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ef0d18e2603c80978de30f1f84dff323bc4409337caa9a14365fb0384f65cb2a/rootfs
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/747a07f6c763ecf2a30c62ab79486dd1588d2d68e76caafc8ba76b0f10b1ee03/rootfs
...
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/f1cdf0c102c83ff88f4b25cf3f2c36c07dae6cfece1dd6ae5854c2bc4d53a3ec/rootfs
...
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/13a16bf814bdaa33830ecfc4a0667ab65a3e8cb4b9f492f12d8fb0eea44d6fc0/rootfs
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/91ea3dd8818ac18f1ee15e5dfb47d0c2edb766ae62ce1796df236c988c10b77d/rootfs
...
overlay                                                                       321G  8.0G  313G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io