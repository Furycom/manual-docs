...
_Last generated at_: **2025-11-26T03:00:44.331362+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2025-11-26T03:00:44.331362+00:00.
...
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 4 days | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
...
> 
> _Generated at_: **2025-11-26T03:00:01**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 4 days, 13 hours, 17 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.03 0.01 0.00 1/561 235177`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:01 up 4 days, 13:17,  0 user,  load average: 0.03, 0.01, 0.00
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.0Gi       1.3Gi       1.8Mi       1.8Gi       2.8Gi
> Swap:          3.8Gi          0B       3.8Gi
> ```
> 
...
> /dev/mapper/ubuntu--vg-ubuntu--lv   19G   11G  6.2G  64% /
> ```
> 
> ## How to refresh this page
> 
...
> - Memory usage: **26.1%** → `OK`
> - CPU load (1 min): **0.03** on **2** cores (per-core: **0.01**) → `OK`
> 
...
> 
> _Generated at_: **2025-11-26T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 13 hours, 36 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.00 0.00 0.00 1/365 2630128`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 14 days, 13:36,  1 user,  load average: 0.00, 0.00, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       3.0Gi       410Mi       456Ki       4.6Gi       4.7Gi
...
> 
> _Generated at_: **2025-11-26T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2025-11-26T03:00:44**
> 
> 
...
> 
> * **Health:** OK (no major issues detected)
> * **Services:** Running: mcp-manual, mcp-gateway, code-server, mcp-shell, netdata, dashy, portainer
> * **Anomalies:** None reported
> * **System uptime:** 4 days, 13 hours, 17 minutes
> * **CPU load:** Low (0.03 on 2 cores)
> * **Memory usage:** OK (26.1% used)
> * **Disk usage:** Warning (64.0% used on /)
> * **Expected containers:** All up and running (except mcp-shell which is not required)
> * **furyai uptime:** 2 weeks, 13 hours, 36 minutes
> * **furyai load average:** Low (0.00 on 4 cores)
> * **furyai memory usage:** OK (3.0Gi used out of 7.7Gi)
> * **furyai disk usage:** Warning (89% used on /)
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        1.12M   667G  1.12M  legacy
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       58.0M   667G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.5M   667G  36.7M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   881G  5.18G  -
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        667G  1.2M  667G   1% /var/lib/kubelet
