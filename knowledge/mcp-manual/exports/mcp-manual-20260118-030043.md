...
_Last generated at_: **2026-01-18T03:00:43.317524+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-18T03:00:43.317524+00:00.
...
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 6 days | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 6 days | `-` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 6 days | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 6 days (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
...
> 
> _Generated at_: **2026-01-18T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 6 days, 13 hours, 38 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.12 0.29 0.29 1/767 1563820`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 6 days, 13:38,  2 users,  load average: 0.12, 0.29, 0.29
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.2Gi       1.3Gi       176Ki       1.6Gi       2.6Gi
> Swap:          3.8Gi       518Mi       3.3Gi
> ```
> 
...
> 
> _Generated at_: **2026-01-18T03:00:03**
> 
> 
> ## Summary
> 
...
> - Memory usage: **30.8%** → `OK`
> - CPU load (1 min): **0.12** on **2** cores (per-core: **0.06**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-18T03:00:07**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 1 week, 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.09 0.02 0.01 1/382 1748362`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 7 days, 12:28,  2 users,  load average: 0.09, 0.02, 0.01
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.1Gi       947Mi       3.6Mi       5.0Gi       5.6Gi
> Swap:           23Gi       696Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2026-01-18T03:00:08**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-18T03:00:42**
> 
> 
...
> ## Summary
> 
> Here is a concise daily summary in English using bullet points:
> 
> * **Overall health**: OK (no major issues detected)
> * **Running services and stacks**:
> 	+ `mcp-manual`: Up 24 hours
> 	+ `mcp-gateway`: Up 2 days
> 	+ `dozzle-agent`, `ntopng`, `termix`, `uptime-kuma`, `code-server`, `mcp-shell`, `portainer`, `netdata`, and `dashy` containers: Up 6 days each
> * **Important running services**:
> 	+ Code server (`code-server`) is up and running
> 	+ Dashy (`dashy`) is up and running
> 	+ Netdata (`netdata`) is up and running (healthy)
> * **Anomalies or errors**:
> 	+ No major issues detected in the MCP health report
> 	+ Root filesystem usage on `/` is 59.0% (OK)
> 	+ Memory usage is 30.8% (OK)
> * **Things that may require attention soon**:
> 	+ Check root filesystem usage regularly to prevent running out of space
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 5 days (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 7 days|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 7 days|| |
| `ollama` | `d353379de60a` | Up 4 days (healthy)|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdl2                                ONLINE       0     0     0
	    sdj2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     0     0 1.15K  too many errors
...
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        2.36M   407G  2.36M  legacy
RZ1-5TB-4X/ix-applications/releases                                           59.8M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
...
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       59.0M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            58.9M   407G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     58.5M   407G  37.7M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  368M  2.3T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        408G  2.4M  408G   1% /var/lib/kubelet
