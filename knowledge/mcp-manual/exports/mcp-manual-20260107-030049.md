...
_Last generated at_: **2026-01-07T03:00:49.099424+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-07T03:00:49.099424+00:00.
...
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 5 days | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 2 weeks | `-` |
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 7 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 2 weeks | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 2 weeks (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 2 weeks | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 2 weeks | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 2 weeks | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 2 weeks (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 2 weeks (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-07T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 2 weeks, 3 days, 7 hours, 42 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.01 0.07 0.10 1/769 3038628`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 17 days,  7:42,  2 users,  load average: 0.01, 0.07, 0.10
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.2Gi       1.2Gi       767Mi       276Ki       1.5Gi       2.0Gi
> Swap:          3.8Gi       455Mi       3.4Gi
> ```
> 
...
> - Memory usage: **37.4%** → `OK`
> - CPU load (1 min): **0.01** on **2** cores (per-core: **0.01**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-07T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 2 weeks, 4 days, 2 hours, 48 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.06 0.04 0.00 2/383 4160069`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 18 days,  2:48,  4 users,  load average: 0.06, 0.04, 0.00
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.2Gi       1.1Gi       644Ki       4.7Gi       5.5Gi
> Swap:           23Gi       120Mi        23Gi
> ```
> 
> ### Root filesystem usage (`df -h /`)
> 
...
> 
> _Generated at_: **2026-01-07T03:00:07**
> 
> 
> ## Connection
> 
...
>   scan: scrub repaired 0B in 00:18:51 with 0 errors on Sun Jan  4 00:18:52 2026
> config:
> 
...
> 
> _Generated at_: **2026-01-07T03:00:48**
> 
> 
...
> * **Overall Health:** OK
> * **Running Services:**
> 	+ `mcp-manual` (MKDocs) running for 24 hours on port 8181
> 	+ `dozzle-agent` (Docker logs aggregator) running for 5 days on ports 7007 and 8080
> 	+ `ntopng` (network traffic analyzer) running for 2 weeks
> 	+ `mcp-gateway` (MCP gateway service) running for 7 hours on port 4000
> * **Important Stacks:**
> 	+ MCP Gateway VM is up for 17 days, with no major issues detected
> 	+ furyai AI/GPU box is up for 18 days, with CPU load at 0.06 and memory usage at 37.4%
> * **Anomalies/Errors:**
> 	+ Root filesystem on the MCP Gateway VM is 58% used (OK)
> 	+ Memory usage on the MCP Gateway VM is within normal limits (37.4%)
> 	+ Disk usage on `/` on the furyai AI/GPU box is 61% used (OK)
> * **Upcoming Maintenance:**
> 	+ None scheduled
> * **System Resources:**
> 	+ CPU cores: 2 (on MCP Gateway) and 4 (on furyai AI/GPU box)
> 	+ Load average: 0.01 on the MCP Gateway VM and 0.06 on the furyai AI/GPU box
> 
> ## How to refresh this page
> 
> From the MCP VM shell, run:
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 5 hours (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 2 weeks|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 2 weeks|| |
| `ollama` | `d353379de60a` | Up 2 weeks (healthy)|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdh2                                ONLINE       0     0     0
	    sdi2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     5 1.11K 4.24K  too many errors
...
RZ1-5TB-4X                                                                    4.86T   298G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.64T   298G  4.64T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.08G   298G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   298G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   298G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.91G   298G  7.91G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        3.69M   298G  3.69M  legacy
RZ1-5TB-4X/ix-applications/releases                                           62.0M   298G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               61.8M   298G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   298G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       61.2M   298G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            61.0M   298G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     60.7M   298G  39.9M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   298G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   298G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   506G  12.4G  -
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   369M  2.27T   369M  legacy
RZ2-11TB-6X/.system/rrd-cadb1ce96f8c4a01a65be3ef8f5cb996                      68.8M  2.27T  68.8M  legacy
RZ2-11TB-6X/.system/samba4                                                    7.17M  2.27T  1.34M  legacy
...
boot-pool/ROOT/23.10.2                                                        5.88G  27.4G  5.88G  legacy
...
RZ1-5TB-4X                                                                    299G  256K  299G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.7T  299G  95% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          300G  908M  299G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/catalogs                                           299G  110M  299G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                    299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                307G  8.0G  299G   3% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                        299G  512K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads  299G  256K  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     299G   40M  299G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                  2.3T  369M  2.3T   1% /var/db/system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        299G  3.8M  299G   1% /var/lib/kubelet
...
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/6b5c2a01847084d875840dc39d3919ca301ab1fd9182cce6ab31be09cbe5ef3b/rootfs
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/ef0d18e2603c80978de30f1f84dff323bc4409337caa9a14365fb0384f65cb2a/rootfs
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/747a07f6c763ecf2a30c62ab79486dd1588d2d68e76caafc8ba76b0f10b1ee03/rootfs
...
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/f1cdf0c102c83ff88f4b25cf3f2c36c07dae6cfece1dd6ae5854c2bc4d53a3ec/rootfs
...
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/13a16bf814bdaa33830ecfc4a0667ab65a3e8cb4b9f492f12d8fb0eea44d6fc0/rootfs
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/91ea3dd8818ac18f1ee15e5dfb47d0c2edb766ae62ce1796df236c988c10b77d/rootfs
...
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/9976f12f720b3fe73dab364c8ea658b3dade472618444ba96cb42aaa0cba419d/rootfs
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io/5354852d8e5b0ce0148afb3b27dcdaf30da800b4dcfc19a39349050d41ff4111/rootfs
overlay                                                                       307G  8.0G  299G   3% /run/k3s/containerd/io.containerd.runtime.v2.task/k8s.io