...
_Last generated at_: **2026-01-11T03:00:44.197154+00:00**

```markdown
[MCP HOMELAB – SUPER PROMPT POUR NOUVELLE SESSION LLM]

Généré automatiquement à partir du manuel MCP le 2026-01-11T03:00:44.197154+00:00.
...
> |------|-------|--------|-------|
> | `mcp-gateway` | `mcp-stack-mcp-gateway` | Up 5 hours | `0.0.0.0:4000->4000/tcp, [::]:4000->4000/tcp` |
> | `mcp-manual` | `squidfunk/mkdocs-material` | Up 12 hours | `0.0.0.0:8181->8000/tcp, [::]:8181->8000/tcp` |
> | `dozzle-agent` | `amir20/dozzle:latest` | Up 12 hours | `0.0.0.0:7007->7007/tcp, [::]:7007->7007/tcp, 8080/tcp` |
> | `ntopng` | `ntop/ntopng:latest` | Up 12 hours | `-` |
> | `termix` | `ghcr.io/lukegus/termix:latest` | Up 12 hours | `30001-30006/tcp, 0.0.0.0:18080->8080/tcp, [::]:18080->8080/tcp` |
> | `uptime-kuma` | `louislam/uptime-kuma:1` | Up 12 hours (healthy) | `0.0.0.0:3001->3001/tcp, [::]:3001->3001/tcp` |
> | `code-server` | `lscr.io/linuxserver/code-server:latest` | Up 12 hours | `0.0.0.0:8080->8443/tcp, [::]:8080->8443/tcp` |
> | `mcp-shell` | `tsl0922/ttyd:latest` | Up 12 hours | `0.0.0.0:7681->7681/tcp, [::]:7681->7681/tcp` |
> | `portainer` | `portainer/portainer-ce:latest` | Up 12 hours | `8000/tcp, 9000/tcp, 0.0.0.0:9443->9443/tcp, [::]:9443->9443/tcp` |
> | `netdata` | `netdata/netdata` | Up 12 hours (healthy) | `0.0.0.0:19999->19999/tcp, [::]:19999->19999/tcp` |
> | `dashy` | `lissy93/dashy` | Up 12 hours (healthy) | `0.0.0.0:9090->8080/tcp, [::]:9090->8080/tcp` |
> 
...
> 
> _Generated at_: **2026-01-11T03:00:02**
> 
> ## General information
> 
> - Hostname: `furymcp`
> - Pretty uptime: `up 12 hours, 26 minutes`
> - CPU cores (nproc): `2`
> - Load average (`/proc/loadavg`): `0.67 0.59 0.54 1/766 121628`
> 
> ## Uptime (raw)
> 
> ```text
> 03:00:02 up 12:26,  1 user,  load average: 0.67, 0.59, 0.54
> ```
> 
> ## Memory usage (`free -h`)
> 
...
> Mem:           3.8Gi       1.1Gi       1.2Gi       312Ki       1.8Gi       2.7Gi
> Swap:          3.8Gi       435Mi       3.4Gi
> ```
> 
...
> - Memory usage: **29.7%** → `OK`
> - CPU load (1 min): **0.67** on **2** cores (per-core: **0.34**) → `OK`
> 
...
> 
> _Generated at_: **2026-01-11T03:00:06**
> 
...
> 
> - Hostname: `furycomai`
> - Pretty uptime: `up 12 hours, 28 minutes`
> - CPU cores (nproc): `4`
> - Load average (`/proc/loadavg`): `0.17 0.14 0.09 2/361 125183`
> 
> ### Uptime (raw)
> 
> ```text
> 03:00:04 up 12:28,  2 users,  load average: 0.17, 0.14, 0.09
> ```
> 
> ### Memory usage (`free -h`)
> 
> ```text
> total        used        free      shared  buff/cache   available
> Mem:           7.7Gi       2.1Gi       842Mi       4.9Mi       5.1Gi       5.6Gi
...
> 
> _Generated at_: **2026-01-11T03:00:07**
> 
> 
> ## Connection
> 
...
> 
> _Generated at_: **2026-01-11T03:00:43**
> 
> 
...
> ## Summary
> 
> Here is the daily MCP summary in English:
> 
> * **Health:** No major issues detected based on current thresholds.
> * **Running services and stacks:**
> 	+ `mcp-gateway` (MCP Gateway VM) - up 5 hours
> 	+ `mcp-manual` (Documentation server) - up 12 hours
> 	+ `dozzle-agent` (Monitoring agent) - up 12 hours
> 	+ `ntopng` (Network traffic monitoring) - up 12 hours
> 	+ `termix` (Terminal multiplexer) - up 12 hours
> 	+ `uptime-kuma` (Uptime monitoring) - up 12 hours
> 	+ `code-server` (Code editor server) - up 12 hours
> 	+ `mcp-shell` (Shell access server) - up 12 hours
> 	+ `portainer` (Container management) - up 12 hours
> 	+ `netdata` (System monitoring) - up 12 hours
> 	+ `dashy` (Dashboard server) - up 12 hours
> * **Anomalies and errors:**
> 	+ No significant issues reported on the MCP Gateway VM or furyai.
> * **Important metrics:**
> 	+ Disk usage on `/`: 58.0% (OK)
> 	+ Memory usage: 29.7% (OK)
> 	+ CPU load (1 min): 0.67 on 2 cores (per-core: 0.34) (OK)
...
| Name | Image | Status |
|------|-------|--------|
| `openwebui` | `ghcr.io/open-webui/open-webui:v0.6.43` | Up 12 hours (healthy)|| |
| `cloudflared` | `cloudflare/cloudflared:2025.11.1` | Up 10 hours|| |
| `dozzle-agent` | `amir20/dozzle:latest` | Up 12 hours|| |
| `ollama` | `d353379de60a` | Up 12 hours (healthy)|| |
...
config:
	...
	RZ1-5TB-4X                              DEGRADED     0     0     0
	  raidz1-0                              DEGRADED     0     0     0
	    ...
	    sdl2                                ONLINE       0     0     0
	    sdj2                                ONLINE       0     0     0
	    ata-SAMSUNG_HD204UI_S2H7J1AZ903382  DEGRADED     0     0    10  too many errors
...
RZ1-5TB-4X                                                                    4.72T   441G   151K  /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         4.50T   441G  4.50T  /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    8.07G   441G   209K  /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/ix-applications/catalogs                                            110M   441G   110M  /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/default_volumes                                     140K   441G   140K  /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/k3s                                                7.90G   441G  7.90G  /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/k3s/kubelet                                        1.94M   441G  1.94M  legacy
RZ1-5TB-4X/ix-applications/releases                                           58.7M   441G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               58.5M   441G   151K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts                         500K   441G   500K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/charts
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       57.9M   441G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes            57.8M   441G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config     57.4M   441G  36.6M  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/config
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads   140K   441G   140K  /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes/ix_volumes/downloads
RZ1-5TB-4X/minecraft                                                           221G   441G   907M  /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/minecraft/Minecraft-mai5pi                                          220G   649G  12.5G  -
RZ2-11TB-6X                                                                   8.50T  2.27T   296K  /mnt/RZ2-11TB-6X
RZ2-11TB-6X/.system                                                           2.61G  2.27T  2.04G  legacy
...
RZ2-11TB-6X/.system/netdata-cadb1ce96f8c4a01a65be3ef8f5cb996                   379M  2.27T   379M  legacy
...
RZ1-5TB-4X                                                                    442G  256K  442G   1% /mnt/RZ1-5TB-4X
RZ1-5TB-4X/RZ1-5TB-4X                                                         5.0T  4.5T  442G  92% /mnt/RZ1-5TB-4X/RZ1-5TB-4X
RZ1-5TB-4X/ix-applications                                                    442G  256K  442G   1% /mnt/RZ1-5TB-4X/ix-applications
RZ1-5TB-4X/minecraft                                                          443G  908M  442G   1% /mnt/RZ1-5TB-4X/minecraft
RZ1-5TB-4X/ix-applications/releases                                           442G  256K  442G   1% /mnt/RZ1-5TB-4X/ix-applications/releases
RZ1-5TB-4X/ix-applications/k3s                                                450G  8.0G  442G   2% /mnt/RZ1-5TB-4X/ix-applications/k3s
RZ1-5TB-4X/ix-applications/default_volumes                                    442G  256K  442G   1% /mnt/RZ1-5TB-4X/ix-applications/default_volumes
RZ1-5TB-4X/ix-applications/catalogs                                           442G  110M  442G   1% /mnt/RZ1-5TB-4X/ix-applications/catalogs
RZ1-5TB-4X/ix-applications/releases/qbittorrent                               442G  256K  442G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent
RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes                       442G  256K  442G   1% /mnt/RZ1-5TB-4X/ix-applications/releases/qbittorrent/volumes
RZ1-5TB-4X/ix-applications/releases/qbittorrent/char