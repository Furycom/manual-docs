...
3) Lancer Pack D (Doc canonique): tout doit vivre dans le Home Lab, être versionné, et rester retrouvable
...
## PACK D — Documentation canonique (nouvelle priorité)
But: Toute la documentation (plans/checklists/consignes/décisions) doit être dans le Home Lab, versionnée, et facile à retrouver.

Référence (gouvernance):
- /home/furycom/manual-docs/operations/DOC_CANONICAL_GOVERNANCE_V1.md

Actions prévues (sans exécution automatique ici):
- D1) Initialiser Git local sur manual-docs (versionning)
- D2) Créer un INDEX.md des docs canoniques + conventions
- D3) Automatiser l’ingestion RAG de la doc canonique après changements
- D4) Procédure “import & compare” pour tout nouveau fichier externe
