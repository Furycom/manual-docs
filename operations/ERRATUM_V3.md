...
- 2026-01-31: protocole COPYBACK + règle “full-file edit” pour éviter les logs sales et les erreurs de copie.
  - COPYBACK: utiliser `bruce_block` et ne renvoyer que le texte entre BEGIN/END.
  - Full-file edit: pour créer/modifier un fichier canonique, réécrire le fichier au complet (pas de patch partiel).
  - Source canon: operations/README_SESSION_GUIDE_LATEST.md (V4+).
